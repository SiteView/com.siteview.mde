...
import com.siteview.mde.internal.launching.launcher.LaunchPluginValidator;
...
public class OSGiLaunchConfigurationDelegate extends LaunchConfigurationDelegate {
	...
	public void launch(ILaunchConfiguration configuration, String mode, ILaunch launch, IProgressMonitor monitor) throws CoreException {
		...
		if (launcher != null) {
			...
			if (name == null)
				name = MDEMessages.OSGiLaunchConfiguration_selected;
			String message = NLS.bind(MDEMessages.OSGiLaunchConfiguration_cannotFindLaunchConfiguration, name);
