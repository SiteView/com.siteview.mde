...
public abstract class AbstractPDELaunchConfiguration extends LaunchConfigurationDelegate {
	...
	protected boolean isLaunchProblem(IMarker problemMarker) throws CoreException {
		return super.isLaunchProblem(problemMarker) && (problemMarker.getType().equals(IJavaModelMarker.JAVA_MODEL_PROBLEM_MARKER) || problemMarker.getType().equals(MDEMarkerFactory.MARKER_ID));
	}
	...
	public String[] getClasspath(ILaunchConfiguration configuration) throws CoreException {
		...
		if (classpath == null) {
			String message = MDEMessages.WorkbenchLauncherConfigurationDelegate_noStartup;
