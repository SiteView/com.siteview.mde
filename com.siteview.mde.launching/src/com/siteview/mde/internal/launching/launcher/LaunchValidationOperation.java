...
import com.siteview.mde.internal.core.BundleValidationOperation;
...
public abstract class LaunchValidationOperation implements IWorkspaceRunnable {
	...
	protected abstract IMonitorModelBase[] getModels() throws CoreException;
	...
	private Properties getJavaProfileProperties(String ee) {
		IMonitorModelBase model = MonitorRegistry.findModel("system.bundle"); //$NON-NLS-1$
		if (model == null)
			return null;
