 ...
 *******************************************************************************/
package com.siteview.mde.internal.runtime.registry;

import com.siteview.mde.internal.runtime.*;
import com.siteview.mde.internal.runtime.registry.model.*;
	...
	protected StyledString getStyledText(Object element) {
		...
		if (element instanceof ServiceRegistration) {
			...
			if (fRegistryBrowser.getGroupBy() == RegistryBrowser.BUNDLES) {
				...
				ss.append(MDERuntimeMessages.RegistryBrowserLabelProvider_RegisteredBy);
		...
		if (element instanceof Folder) {
			...
			switch (((Folder) element).getId()) {
				case Folder.F_IMPORTS :
					text = MDERuntimeMessages.RegistryView_folders_imports;
					break;
				case Folder.F_IMPORTED_PACKAGES :
					text = MDERuntimeMessages.RegistryBrowserLabelProvider_ImportedPackages;
					break;
				case Folder.F_EXPORTED_PACKAGES :
					text = MDERuntimeMessages.RegistryBrowserLabelProvider_ExportedPackages;
					break;
				case Folder.F_LIBRARIES :
					text = MDERuntimeMessages.RegistryView_folders_libraries;
					break;
				case Folder.F_EXTENSION_POINTS :
					text = MDERuntimeMessages.RegistryView_folders_extensionPoints;
					break;
				case Folder.F_EXTENSIONS :
					text = MDERuntimeMessages.RegistryView_folders_extensions;
					break;
				case Folder.F_REGISTERED_SERVICES :
					text = MDERuntimeMessages.RegistryBrowserLabelProvider_registeredServices;
					break;
				case Folder.F_SERVICES_IN_USE :
					text = MDERuntimeMessages.RegistryBrowserLabelProvider_usedServices;
					break;
				case Folder.F_PROPERTIES :
					text = MDERuntimeMessages.RegistryBrowserLabelProvider_Properties;
					break;
				case Folder.F_USING_BUNDLES :
					text = MDERuntimeMessages.RegistryBrowserLabelProvider_UsingBundles;
					break;
				case Folder.F_FRAGMENTS :
					text = MDERuntimeMessages.RegistryBrowserLabelProvider_Fragments;
					break;
			}
		...
		if (element instanceof Extension) {
			...
			return new StyledString(NLS.bind(MDERuntimeMessages.RegistryBrowserLabelProvider_contributedBy, contributor));
