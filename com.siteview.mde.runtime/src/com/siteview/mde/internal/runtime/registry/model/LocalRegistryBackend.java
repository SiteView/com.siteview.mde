 ...
 *******************************************************************************/
package com.siteview.mde.internal.runtime.registry.model;
...
public class LocalRegistryBackend implements IRegistryEventListener, BundleListener, ServiceListener, RegistryBackend {
	...
	public MultiStatus diagnose(long id) {
		...
		MultiStatus problems = new MultiStatus(PDERuntimePlugin.ID, IStatus.INFO, MDERuntimeMessages.RegistryView_found_problems, null);
