...
public class ActiveShellSection implements ISpySection {
	...
	public void build(ScrolledForm form, SpyFormToolkit toolkit, ExecutionEvent event) {
		...
		section.setText(MDERuntimeMessages.SpyDialog_activeShell_title);
		...
		buffer.append(toolkit.createClassSection(text, MDERuntimeMessages.SpyDialog_activeShell_desc, new Class[] {clazz}));
