 ...
 *******************************************************************************/
package com.siteview.mde.internal.runtime.spy.dialogs;
...
import com.siteview.mde.internal.runtime.spy.sections.ActiveMenuSection;
...
public class MenuSpyDialog extends PopupDialog {
	...
	private class CloseAction extends Action {
		...
		public String getToolTipText() {
			return MDERuntimeMessages.SpyDialog_close;
		}
	...
	protected Control createDialogArea(Composite parent) {
		...
		// set title and image
		form.setText(MDERuntimeMessages.MenuSpyDialog_title);
