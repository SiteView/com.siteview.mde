...
public class ActiveFormEditorSection implements ISpySection {
	...
	public void build(ScrolledForm form, SpyFormToolkit toolkit, ExecutionEvent event) {
		...
		section.setText(MDERuntimeMessages.ActiveFormEditorSection_Active_Form_Page);
		...
		buffer.append(toolkit.createClassSection(text, NLS.bind(MDERuntimeMessages.SpyDialog_activePart_desc, "editor tab"), new Class[] {activePage.getClass()})); //$NON-NLS-1$
		buffer.append("</form>"); //$NON-NLS-1$
