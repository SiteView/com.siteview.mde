...
public class MDERuntimeMessages extends NLS {
	private static final String BUNDLE_NAME = "com.siteview.mde.internal.runtime.pderuntimeresources";//$NON-NLS-1$
	...
	static {
		...
		NLS.initializeMessages(BUNDLE_NAME, MDERuntimeMessages.class);
	}
