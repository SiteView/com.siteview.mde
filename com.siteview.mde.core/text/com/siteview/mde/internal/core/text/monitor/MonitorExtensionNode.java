...
public class MonitorExtensionNode extends MonitorParentNode implements IMonitorExtension {
	...
	public String getTranslatedName() {
		...
		ISchema schema = MDECore.getDefault().getSchemaRegistry().getSchema(point);
