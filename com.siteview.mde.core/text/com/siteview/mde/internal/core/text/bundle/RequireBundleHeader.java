...
public class RequireBundleHeader extends CompositeManifestHeader {
	...
	public void addBundle(IMonitorImport iimport) {
	 ...
	 * @param index
	 */
	public void addBundle(IMonitorImport iimport, int index) {
	...
	public void updateBundle(int index, IMonitorImport iimport) {
		if (index == -1)
			return;
