...
public class MonitorImportNode extends MonitorObjectNode implements IMonitorImport {

	private static final long serialVersionUID = 1L;

	public MonitorImportNode(String id) {
		super();
		String name = "plugin"; //$NON-NLS-1$
		try {
			if (id == null)
				id = ""; //$NON-NLS-1$
			MonitorAttribute attr = new MonitorAttribute();
			attr.setName(name);
