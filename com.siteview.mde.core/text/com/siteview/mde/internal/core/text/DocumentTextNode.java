...
public class DocumentTextNode extends DocumentXMLNode implements IDocumentTextNode {
	...
	/* (non-Javadoc)
	 * @see com.siteview.mde.internal.core.text.IDocumentTextNode#reconnectText(com.siteview.mde.internal.core.text.IDocumentElementNode)
	 */
	...
	/* (non-Javadoc)
	 * @see com.siteview.mde.internal.core.text.IDocumentTextNode#write()
	 */
	public String write() {
