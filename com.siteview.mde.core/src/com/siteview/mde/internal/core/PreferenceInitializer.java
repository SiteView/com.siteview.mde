...
public class PreferenceInitializer extends AbstractPreferenceInitializer {
	...
	public void initializeDefaultPreferences() {
		IEclipsePreferences defaultPreferences = new DefaultScope().getNode(MDECore.PLUGIN_ID);
		IEclipsePreferences preferences = new InstanceScope().getNode(MDECore.PLUGIN_ID);
		...
		IEclipsePreferences prefs = new DefaultScope().getNode(MDE.PLUGIN_ID);
