...
public class ExternalJavaSearchInitializer extends ClasspathContainerInitializer {
	...
	public void initialize(IPath containerPath, IJavaProject javaProject) throws CoreException {
		try {
			JavaCore.setClasspathContainer(MDECore.JAVA_SEARCH_CONTAINER_PATH, new IJavaProject[] {javaProject}, new IClasspathContainer[] {new ExternalJavaSearchClasspathContainer()}, null);
