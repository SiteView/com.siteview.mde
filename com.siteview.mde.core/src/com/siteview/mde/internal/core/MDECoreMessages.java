...
public class MDECoreMessages extends NLS {
	private static final String BUNDLE_NAME = "com.siteview.mde.internal.core.pderesources";//$NON-NLS-1$
	...
	static {
		...
		NLS.initializeMessages(BUNDLE_NAME, MDECoreMessages.class);
	}
