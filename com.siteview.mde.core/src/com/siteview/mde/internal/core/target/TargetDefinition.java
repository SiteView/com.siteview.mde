...
import com.siteview.mde.internal.core.ExternalFeatureModelManager;
...
public class TargetDefinition implements ITargetDefinition {
	...
	/* (non-Javadoc)
	 * @see com.siteview.mde.internal.core.target.provisional.ITargetDefinition#getArch()
	 */
	...
	/* (non-Javadoc)
	 * @see com.siteview.mde.internal.core.target.provisional.ITargetDefinition#getBundleContainers()
	 */
	...
	/* (non-Javadoc)
	 * @see com.siteview.mde.internal.core.target.provisional.ITargetDefinition#getNL()
	 */
	public String getNL() {
		return fNL;
	}
	...
	/* (non-Javadoc)
	 * @see com.siteview.mde.internal.core.target.provisional.ITargetDefinition#getName()
	 */
	...
	/* (non-Javadoc)
	 * @see com.siteview.mde.internal.core.target.provisional.ITargetDefinition#getOS()
	 */
	public String getOS() {
		return fOS;
	}
	...
	/* (non-Javadoc)
	 * @see com.siteview.mde.internal.core.target.provisional.ITargetDefinition#getProgramArguments()
	 */
	...
	/* (non-Javadoc)
	 * @see com.siteview.mde.internal.core.target.provisional.ITargetDefinition#getVMArguments()
	 */
	...
	/* (non-Javadoc)
	 * @see com.siteview.mde.internal.core.target.provisional.ITargetDefinition#getWS()
	 */
	public String getWS() {
		return fWS;
	}
	...
	/* (non-Javadoc)
	 * @see com.siteview.mde.internal.core.target.provisional.ITargetDefinition#setArch(java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see com.siteview.mde.internal.core.target.provisional.ITargetDefinition#setNL(java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see com.siteview.mde.internal.core.target.provisional.ITargetDefinition#setName(java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see com.siteview.mde.internal.core.target.provisional.ITargetDefinition#setOS(java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see com.siteview.mde.internal.core.target.provisional.ITargetDefinition#setProgramArguments(java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see com.siteview.mde.internal.core.target.provisional.ITargetDefinition#setVMArguments(java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see com.siteview.mde.internal.core.target.provisional.ITargetDefinition#setWS(java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see com.siteview.mde.internal.core.target.provisional.ITargetDefinition#setBundleContainers(com.siteview.mde.internal.core.target.provisional.IBundleContainer[])
	 */
	...
	/* (non-Javadoc)
	 * @see com.siteview.mde.internal.core.target.provisional.ITargetDefinition#resolve(org.eclipse.core.runtime.IProgressMonitor)
	 */
	public IStatus resolve(IProgressMonitor monitor) {
		...
		try {
			MultiStatus status = new MultiStatus(MDECore.PLUGIN_ID, 0, Messages.TargetDefinition_2, null);
			if (containers != null) {
				for (int i = 0; i < containers.length; i++) {
	...
	/* (non-Javadoc)
	 * @see com.siteview.mde.internal.core.target.provisional.ITargetDefinition#isResolved()
	 */
	...
	/* (non-Javadoc)
	 * @see com.siteview.mde.internal.core.target.provisional.ITargetDefinition#getBundleStatus()
	 */
	public IStatus getBundleStatus() {
		if (isResolved()) {
			...
			if (containers != null) {
				...
				MultiStatus result = new MultiStatus(MDECore.PLUGIN_ID, 0, Messages.TargetDefinition_5, null);
				for (int i = 0; i < containers.length; i++) {
					IBundleContainer container = containers[i];
	...
	/* (non-Javadoc)
	 * @see com.siteview.mde.internal.core.target.provisional.ITargetDefinition#setIncluded(com.siteview.mde.internal.core.target.provisional.NameVersionDescriptor[])
	 */
	...
	/* (non-Javadoc)
	 * @see com.siteview.mde.internal.core.target.provisional.ITargetDefinition#getIncluded()
	 */
	...
	/* (non-Javadoc)
	 * @see com.siteview.mde.internal.core.target.provisional.ITargetDefinition#setOptional(com.siteview.mde.internal.core.target.provisional.NameVersionDescriptor[])
	 */
	...
	/* (non-Javadoc)
	 * @see com.siteview.mde.internal.core.target.provisional.ITargetDefinition#getOptional()
	 */
	...
	/* (non-Javadoc)
	 * @see com.siteview.mde.internal.core.target.provisional.ITargetDefinition#getBundles()
	 */
	...
	/* (non-Javadoc)
	 * @see com.siteview.mde.internal.core.target.provisional.ITargetDefinition#getAllBundles()
	 */
	...
	private IResolvedBundle[] filterBundles(IResolvedBundle[] bundles, NameVersionDescriptor[] filter) {
		...
		if (containsFeatures && !missingFeatures.isEmpty()) {
			for (Iterator iterator = missingFeatures.iterator(); iterator.hasNext();) {
				...
				Status status = new Status(IStatus.ERROR, MDECore.PLUGIN_ID, IResolvedBundle.STATUS_FEATURE_DOES_NOT_EXIST, message, null);
	...
	private static IResolvedBundle resolveBundle(Map bundleMap, BundleInfo info, boolean optional, IBundleContainer errorParentContainer) {
		...
		if (list != null) {
			...
			return new ResolvedBundle(info, errorParentContainer, new Status(sev, MDECore.PLUGIN_ID, IResolvedBundle.STATUS_VERSION_DOES_NOT_EXIST, message, null), null, optional, false);
		}
		// DOES NOT EXIST
		if (errorParentContainer == null) {
			return null;
		...
		return new ResolvedBundle(info, errorParentContainer, new Status(sev, MDECore.PLUGIN_ID, IResolvedBundle.STATUS_PLUGIN_DOES_NOT_EXIST, message, null), null, optional, false);
	}

	/* (non-Javadoc)
	 * @see com.siteview.mde.internal.core.target.provisional.ITargetDefinition#getHandle()
	 */
	...
	private void abort(String message, Exception e) throws CoreException {
		throw new CoreException(new Status(IStatus.ERROR, MDECore.PLUGIN_ID, message, e));
	}

	/* (non-Javadoc)
	 * @see com.siteview.mde.internal.core.target.provisional.ITargetDefinition#getImplicitDependencies()
	 */
	...
	/* (non-Javadoc)
	 * @see com.siteview.mde.internal.core.target.provisional.ITargetDefinition#setImplicitDependencies(com.siteview.mde.internal.core.target.provisional.NameVersionDescriptor[])
	 */
	...
	/* (non-Javadoc)
	 * @see com.siteview.mde.internal.core.target.provisional.ITargetDefinition#getJREContainer()
	 */
	...
	/* (non-Javadoc)
	 * @see com.siteview.mde.internal.core.target.provisional.ITargetDefinition#setJREContainer(org.eclipse.core.runtime.IPath)
	 */
	...
	/* (non-Javadoc)
	 * @see com.siteview.mde.internal.core.target.provisional.ITargetDefinition#getAllFeatures()
	 */
