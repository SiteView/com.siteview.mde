...
public class ResolvedBundle implements IResolvedBundle {
	...
	/* (non-Javadoc)
	 * @see com.siteview.mde.internal.core.target.provisional.IResolvedBundle#getBundleInfo()
	 */
	...
	/* (non-Javadoc)
	 * @see com.siteview.mde.internal.core.target.provisional.IResolvedBundle#getParentContainer()
	 */
	...
	/* (non-Javadoc)
	 * @see com.siteview.mde.internal.core.target.provisional.IResolvedBundle#setParentContainer(com.siteview.mde.internal.core.target.provisional.IBundleContainer)
	 */
	...
	/* (non-Javadoc)
	 * @see com.siteview.mde.internal.core.target.provisional.IResolvedBundle#getStatus()
	 */
	...
	/* (non-Javadoc)
	 * @see com.siteview.mde.internal.core.target.provisional.IResolvedBundle#isOptional()
	 */
	...
	/* (non-Javadoc)
	 * @see com.siteview.mde.internal.core.target.provisional.IResolvedBundle#isSourceBundle()
	 */
	...
	/* (non-Javadoc)
	 * @see com.siteview.mde.internal.core.target.provisional.IResolvedBundle#getSourceTarget()
	 */
	...
	/* (non-Javadoc)
	 * @see com.siteview.mde.internal.core.target.provisional.IResolvedBundle#isFragment()
	 */
