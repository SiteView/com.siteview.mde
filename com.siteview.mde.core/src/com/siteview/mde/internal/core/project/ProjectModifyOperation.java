...
public class ProjectModifyOperation {
	...
	public void execute(IProgressMonitor monitor, IBundleProjectDescription description) throws CoreException {
		...
		IBundleProjectService service = (IBundleProjectService) MDECore.getDefault().acquireService(IBundleProjectService.class.getName());
		...
		if (pref != null) {
			...
			try {
				...
				throw new CoreException(new Status(IStatus.ERROR, MDECore.PLUGIN_ID, Messages.ProjectModifyOperation_2, e));
			}
		}
