...
public class SiteBuildOperation extends FeatureBasedExportOperation {
	...
	/* (non-Javadoc)
	 * @see com.siteview.mde.internal.core.exports.FeatureBasedExportOperation#createPostProcessingFiles()
	 */
	...
	protected void setP2MetaDataProperties(Map map) {
		if (fInfo.toDirectory) {
			...
			String name = description != null && description.getName() != null && description.getName().length() > 0 ? description.getName() : MDECoreMessages.SiteBuildOperation_0;
