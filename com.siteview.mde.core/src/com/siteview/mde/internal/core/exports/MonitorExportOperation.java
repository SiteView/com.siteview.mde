...
public class MonitorExportOperation extends FeatureBasedExportOperation {

	public MonitorExportOperation(FeatureExportInfo info, String name) {
		super(info, name);
	}
	...
	/* (non-Javadoc)
	 * @see com.siteview.mde.internal.core.exports.FeatureExportOperation#setAdditionalAttributes(org.w3c.dom.Element, org.eclipse.osgi.service.resolver.BundleDescription)
	 */
