...
public class SchemaCompositor extends RepeatableSchemaObject implements ISchemaCompositor {
	...
	public SchemaCompositor(ISchemaObject parent, int kind) {
		...
		switch (kind) {
			case ALL :
				fName = MDECoreMessages.SchemaCompositor_all;
				break;
			case CHOICE :
				fName = MDECoreMessages.SchemaCompositor_choice;
				break;
			case GROUP :
				fName = MDECoreMessages.SchemaCompositor_group;
				break;
			case SEQUENCE :
				fName = MDECoreMessages.SchemaCompositor_sequence;
				break;
		}
	}
