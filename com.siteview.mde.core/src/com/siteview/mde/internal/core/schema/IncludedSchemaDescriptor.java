...
public class IncludedSchemaDescriptor implements ISchemaDescriptor {
	...
	private static URL getPluginRelativePath(String pluginID, IPath path, URL parentURL) {
		...
		if (url == null) {
			...
			if (model != null)
				url = SchemaRegistry.getSchemaFromSourceExtension(model.getMonitorBase(), path);
		}
		try {
	...
	/**
	 * @see com.siteview.mde.internal.core.schema.AbstractSchemaDescriptor#isEnabled()
	 */
	...
	/**
	 * @see com.siteview.mde.internal.core.ischema.ISchemaDescriptor#getPointId()
	 */
	...
	/**
	 * @see com.siteview.mde.internal.core.ischema.ISchemaDescriptor#getSchemaURL()
	 */
	...
	/* (non-Javadoc)
	 * @see com.siteview.mde.internal.core.ischema.ISchemaDescriptor#getSchema(boolean)
	 */
	...
	/* (non-Javadoc)
	 * @see com.siteview.mde.internal.core.ischema.ISchemaDescriptor#isStandalone()
	 */
	...
	/* (non-Javadoc)
	 * @see com.siteview.mde.internal.core.ischema.ISchemaDescriptor#getLastModified()
	 */
