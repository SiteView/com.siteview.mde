...
import com.siteview.mde.internal.core.ischema.IMetaElement;
...
import com.siteview.mde.internal.core.ischema.ISchemaObjectReference;
...
public class SchemaElementReference extends PlatformObject implements ISchemaElement, IMetaElement, ISchemaObjectReference, ISourceObject, Serializable {
	...
	public String getDTDRepresentation(boolean addLinks) {
		if (element == null)
			return MDECoreMessages.SchemaElementReference_refElementMissing;
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.siteview.mde.internal.core.ischema.IMetaElement#isTranslatable()
	 */
	...
	/* (non-Javadoc)
	 * @see com.siteview.mde.internal.core.ischema.IMetaElement#isDeprecated()
	 */
