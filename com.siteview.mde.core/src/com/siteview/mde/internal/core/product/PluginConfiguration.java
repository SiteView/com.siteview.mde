...
import com.siteview.mde.internal.core.iproduct.IPluginConfiguration;
...
public class PluginConfiguration extends ProductObject implements IPluginConfiguration {
	...
	/* (non-Javadoc)
	 * @see com.siteview.mde.internal.core.iproduct.IPluginConfiguration#getId()
	 */
	public String getId() {
		return fId;
	}
	...
	/* (non-Javadoc)
	 * @see com.siteview.mde.internal.core.iproduct.IPluginConfiguration#getStartLevel()
	 */
	...
	/* (non-Javadoc)
	 * @see com.siteview.mde.internal.core.iproduct.IPluginConfiguration#isAutoStart()
	 */
	...
	/* (non-Javadoc)
	 * @see com.siteview.mde.internal.core.iproduct.IPluginConfiguration#setAutoStart(boolean)
	 */
	...
	/* (non-Javadoc)
	 * @see com.siteview.mde.internal.core.iproduct.IPluginConfiguration#setStartLevel(java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see com.siteview.mde.internal.core.iproduct.IProductPluginConfiguration#setId(java.lang.String)
	 */
