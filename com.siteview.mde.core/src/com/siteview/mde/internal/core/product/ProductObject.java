...
import com.siteview.mde.internal.core.iproduct.IProductObject;
...
public abstract class ProductObject extends PlatformObject implements IProductObject {
	...
	/* (non-Javadoc)
	 * @see com.siteview.mde.internal.core.iproduct.IProductObject#getModel()
	 */
	...
	/* (non-Javadoc)
	 * @see com.siteview.mde.internal.core.iproduct.IProductObject#getProduct()
	 */
