...
public class ProductModelFactory implements IProductModelFactory {
	...
	/* (non-Javadoc)
	 * @see com.siteview.mde.internal.core.iproduct.IProductModelFactory#createProduct()
	 */
	...
	/* (non-Javadoc)
	 * @see com.siteview.mde.internal.core.iproduct.IProductModelFactory#createAboutInfo()
	 */
	...
	/* (non-Javadoc)
	 * @see com.siteview.mde.internal.core.iproduct.IProductModelFactory#createPlugin()
	 */
	...
	/* (non-Javadoc)
	 * @see com.siteview.mde.internal.core.iproduct.IProductModelFactory#createPluginConfiguration()
	 */
	...
	/* (non-Javadoc)
	 * @see com.siteview.mde.internal.core.iproduct.IProductModelFactory#createPropertyConfiguration()
	 */
	...
	/* (non-Javadoc)
	 * @see com.siteview.mde.internal.core.iproduct.IProductModelFactory#createConfigFileInfo()
	 */
