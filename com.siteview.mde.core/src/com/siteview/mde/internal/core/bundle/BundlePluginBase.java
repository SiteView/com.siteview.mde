...
import com.siteview.mde.internal.core.ibundle.IBundlePluginBase;
...
import com.siteview.mde.internal.core.monitor.AbstractExtensions;
import com.siteview.mde.internal.core.monitor.MonitorImport;
import com.siteview.mde.internal.core.monitor.MonitorLibrary;
import com.siteview.mde.internal.core.text.bundle.BundleClasspathHeader;
import com.siteview.mde.internal.core.text.bundle.BundleNameHeader;
import com.siteview.mde.internal.core.text.bundle.BundleSymbolicNameHeader;
import com.siteview.mde.internal.core.text.bundle.BundleVendorHeader;
import com.siteview.mde.internal.core.text.bundle.BundleVersionHeader;
import com.siteview.mde.internal.core.text.bundle.RequireBundleHeader;
...
public class BundlePluginBase extends PlatformObject implements IBundlePluginBase, Serializable {
	...
	public String getSchemaVersion() {
		...
		return (root instanceof IMonitorBase) ? ((IMonitorBase) root).getSchemaVersion() : null;
	}
	...
	public void setSchemaVersion(String value) throws CoreException {
		...
		if (root instanceof IMonitorBase)
			((IMonitorBase) root).setSchemaVersion(value);
	}
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.siteview.mde.internal.core.ibundle.IBundlePluginBase#getBundle()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.siteview.mde.internal.core.ibundle.IBundlePluginBase#getExtensionsRoot()
	 */
	 ...
	 * @param header
	 */
	private void addLibrary(IMonitorLibrary library, IManifestHeader header) {
	 ...
	 */
	private void removeLibrary(IMonitorLibrary library, IManifestHeader header) {
		String value = header == null ? null : header.getValue();
	...
	private void addImport(IMonitorImport iimport) {
		imports.add(iimport);
	...
	public void remove(IMonitorImport[] pluginImports) throws CoreException {
		ensureModelEditable();
		if (imports != null) {
	...
	public IMonitorLibrary[] getLibraries() {
		...
		return (IMonitorLibrary[]) libraries.toArray(new IMonitorLibrary[libraries.size()]);
	}
	...
	public IMonitorImport[] getImports() {
		...
		return (IMonitorImport[]) imports.toArray(new IMonitorImport[imports.size()]);
	}
	...
	public void setProviderName(String providerName) throws CoreException {
		...
		if (bundle != null) {
			...
			model.fireModelObjectChanged(this, IMonitorBase.P_PROVIDER, old, providerName);
		}
	}
	...
	public void setVersion(String version) throws CoreException {
		...
		if (bundle != null) {
			...
			model.fireModelObjectChanged(this, IMonitorBase.P_VERSION, old, version);
		}
	}
	...
	public void setName(String name) throws CoreException {
		...
		if (bundle != null) {
			...
			model.fireModelObjectChanged(this, IMonitorObject.P_NAME, old, name);
		}
	}
	...
	public void updateImport(IMonitorImport iimport) {
		Object header = getManifestHeader(Constants.REQUIRE_BUNDLE);
	...
	/* (non-Javadoc)
	 * @see com.siteview.mde.internal.core.ibundle.IBundlePluginBase#getIndexOf(org.eclipse.pde.core.plugin.IPluginImport)
	 */
	public int getIndexOf(IMonitorImport targetImport) {
		if (imports == null) {
			return -1;
		}
	...
	/* (non-Javadoc)
	 * @see com.siteview.mde.internal.core.ibundle.IBundlePluginBase#getPreviousImport(org.eclipse.pde.core.plugin.IPluginImport)
	 */
	public IMonitorImport getPreviousImport(IMonitorImport targetImport) {
		...
		IMonitorImport previousImport = (IMonitorImport) imports.get(targetIndex - 1);

		return previousImport;
	}

	/* (non-Javadoc)
	 * @see com.siteview.mde.internal.core.ibundle.IBundlePluginBase#getNextImport(org.eclipse.pde.core.plugin.IPluginImport)
	 */
	public IMonitorImport getNextImport(IMonitorImport targetImport) {
		// Ensure we have imports
		if (imports == null) {
			return null;
		} else if (imports.size() <= 1) {
		...
		IMonitorImport nextImport = (IMonitorImport) imports.get(targetIndex + 1);

		return nextImport;
	}

	/* (non-Javadoc)
	 * @see com.siteview.mde.internal.core.ibundle.IBundlePluginBase#add(org.eclipse.pde.core.plugin.IPluginImport, int)
	 */
	public void add(IMonitorImport iimport, int index) throws CoreException {
		ensureModelEditable();
		int importCount = 0;
		if (imports != null) {
	 ...
	 * @param index
	 */
	private void addImport(IMonitorImport iimport, int index) {
		// Get the header
	...
	/* (non-Javadoc)
	 * @see com.siteview.mde.internal.core.ibundle.IBundlePluginBase#add(org.eclipse.pde.core.plugin.IPluginLibrary, int)
	 */
	public void add(IMonitorLibrary library, int index) throws CoreException {
		ensureModelEditable();
		int libraryCount = 0;
		if (libraries != null) {
	...
	/* (non-Javadoc)
	 * @see com.siteview.mde.internal.core.ibundle.IBundlePluginBase#getIndexOf(org.eclipse.pde.core.plugin.IPluginLibrary)
	 */
	public int getIndexOf(IMonitorLibrary targetLibrary) {
		if (libraries == null) {
			return -1;
		}
	...
	/* (non-Javadoc)
	 * @see com.siteview.mde.internal.core.ibundle.IBundlePluginBase#getNextLibrary(org.eclipse.pde.core.plugin.IPluginLibrary)
	 */
	public IMonitorLibrary getNextLibrary(IMonitorLibrary targetLibrary) {
		...
		IMonitorLibrary nextLibrary = (IMonitorLibrary) libraries.get(targetIndex + 1);

		return nextLibrary;
	}

	/* (non-Javadoc)
	 * @see com.siteview.mde.internal.core.ibundle.IBundlePluginBase#getPreviousLibrary(org.eclipse.pde.core.plugin.IPluginLibrary)
	 */
	public IMonitorLibrary getPreviousLibrary(IMonitorLibrary targetLibrary) {
		// Ensure we have libraries
		if (libraries == null) {
			return null;
		} else if (libraries.size() <= 1) {
		...
		IMonitorLibrary previousLibrary = (IMonitorLibrary) libraries.get(targetIndex - 1);
