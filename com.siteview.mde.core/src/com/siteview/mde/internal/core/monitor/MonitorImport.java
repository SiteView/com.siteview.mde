...
public class MonitorImport extends IdentifiableMonitorObject implements IMonitorImport, Serializable {
	...
	public MonitorImport(ISharedMonitorModel model, String id) {
		try {
			setModel(model);
			ensureModelEditable();
			this.fID = id;
	...
	public void load(ManifestElement element, int bundleManifestVersion) {
		...
		if (bundleVersion != null) {
			try {
				...
				this.match = MonitorBase.getMatchRule(versionRange);
	...
	public boolean equals(Object obj) {
		...
		if (obj instanceof IMonitorImport) {
			IMonitorImport target = (IMonitorImport) obj;
	...
	/* (non-Javadoc)
	 * @see com.siteview.mde.internal.core.plugin.IdentifiablePluginObject#reconnect(org.eclipse.pde.core.plugin.ISharedPluginModel, org.eclipse.pde.core.plugin.IPluginObject)
	 */
	...
	/* (non-Javadoc)
	 * @see com.siteview.mde.internal.core.plugin.PluginObject#writeDelimeter(java.io.PrintWriter)
	 */
