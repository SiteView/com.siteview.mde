...
public class MonitorExtension extends MonitorParent implements IMonitorExtension {
	...
	public MonitorExtension(IExtension extension) {
	...
	public boolean equals(Object obj) {
		...
		if (obj instanceof IMonitorExtension) {
			IMonitorExtension target = (IMonitorExtension) obj;
	...
	public void write(String indent, PrintWriter writer) {
		...
		String attIndent = indent + MonitorElement.ATTRIBUTE_SHIFT;
		if (getId() != null) {
			writer.println();
		...
		for (int i = 0; i < children.length; i++) {
			...
			child.write(indent + MonitorElement.ELEMENT_SHIFT, writer);
		}
