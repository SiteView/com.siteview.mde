...
public abstract class ExternalMonitorModelBase extends AbstractMonitorModelBase {
	...
	public ExternalMonitorModelBase() {
		super();
	}

	protected NLResourceHelper createNLResourceHelper() {
		return (fLocalization == null) ? null : new NLResourceHelper(fLocalization, MDEManager.getNLLookupLocations(this));
	}
