...
public class TracingOptionsManager {
	...
	private void addToTemplate(IMonitorModelBase model) {
	...
	public static boolean isTraceable(IMonitorModelBase model) {
	...
	private Properties getOptions(IMonitorModelBase model) {
		String location = model.getInstallLocation();
		if (location == null)
			return null;
