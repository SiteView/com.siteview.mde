...
public class BinaryRepositoryProvider extends RepositoryProvider {
	...
	public void configureProject() throws CoreException {
		...
		project.setPersistentProperty(MDECore.EXTERNAL_PROJECT_PROPERTY, EXTERNAL_PROJECT_VALUE);
	}
	...
	public void deconfigure() throws CoreException {
		IProject project = getProject();
		project.setPersistentProperty(MDECore.EXTERNAL_PROJECT_PROPERTY, null);
	}
	 ...
	 */
	public String getID() {
		return MDECore.BINARY_REPOSITORY_PROVIDER;
	}
	...
	private IStatus createProblemStatus() {
		String message = MDECoreMessages.BinaryRepositoryProvider_veto;
		return new Status(IStatus.ERROR, MDECore.PLUGIN_ID, IStatus.OK, message, null);
	}

	private IStatus createOKStatus() {
		return new Status(IStatus.OK, MDECore.PLUGIN_ID, IStatus.OK, "", //$NON-NLS-1$
				null);
	}
