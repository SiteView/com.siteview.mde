...
public class VersionUtil {
	...
	public static IStatus validateVersion(String versionString) {
		try {
			...
			return new Status(IStatus.ERROR, MDECore.PLUGIN_ID, IStatus.ERROR, MDECoreMessages.BundleErrorReporter_InvalidFormatInBundleVersion, e);
		}
	...
	public static IStatus validateVersionRange(String versionRangeString) {
		try {
			...
			return new Status(IStatus.ERROR, MDECore.PLUGIN_ID, IStatus.ERROR, MDECoreMessages.BundleErrorReporter_invalidVersionRangeFormat, e);
		}
		return Status.OK_STATUS;
	}
