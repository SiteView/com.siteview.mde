 ...
 * @since 3.0
 */
public interface IExtensions extends IMonitorObject {
	/**
	 ...
	 */
	void add(IMonitorExtension extension) throws CoreException;
	 ...
	 */
	IMonitorExtension[] getExtensions();
	 ...
	 * @throws CoreException if the model is not editable
	 */
	void remove(IMonitorExtension extension) throws CoreException;
	 ...
	 * @throws CoreException if the model is not editable
	 */
	void swap(IMonitorExtension e1, IMonitorExtension e2) throws CoreException;
	 ...
	 */
	int getIndexOf(IMonitorExtension e);
}
