 ...
 */
public interface IMonitorParent extends IMonitorObject {
	/**
	 ...
	 */
	void add(int index, IMonitorObject child) throws CoreException;
	 ...
	 * @throws CoreException if the model is not editable
	 */
	void add(IMonitorObject child) throws CoreException;
	 ...
	 */
	int getIndexOf(IMonitorObject child);
	 ...
	 */
	void swap(IMonitorObject child1, IMonitorObject child2) throws CoreException;
	 ...
	 * @throws CoreException if the model is not editable
	 */
	void remove(IMonitorObject child) throws CoreException;
}
