 ...
 * </p>
 * @see IMonitorReference
 * @since 3.4
 * 
 * @noextend This class is not intended to be subclassed by clients.
 */
public class PluginReference implements IMonitorReference {
	...
	public boolean equals(Object object) {
		if (object instanceof IMonitorReference) {
			IMonitorReference source = (IMonitorReference) object;
			if (id == null)
				return false;
