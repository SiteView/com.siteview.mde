...
import com.siteview.mde.internal.ui.wizards.plugin.*;
...
public abstract class NewPluginProjectFromTemplateWizard extends NewWizard implements IExecutableExtension {
	...
	public void addPages() {
		...
		if (templateWizardElement == null) {
			MessageDialog.openError(getShell(), MDEUIMessages.NewPluginProjectFromTemplateWizard_1, NLS.bind(MDEUIMessages.NewPluginProjectFromTemplateWizard_0, getTemplateID()));
			return;
		}

		fProjectPage = new NewProjectCreationFromTemplatePage("main", fPluginData, getSelection(), templateWizardElement); //$NON-NLS-1$
		fProjectPage.setTitle(MDEUIMessages.NewProjectWizard_MainPage_title);
		fProjectPage.setDescription(MDEUIMessages.NewProjectWizard_MainPage_desc);
