 ...
 * </p>
 * @since 3.2
 * @deprecated use {@link com.siteview.mde.launching.EquinoxLaunchConfiguration} instead.
 * @see com.siteview.mde.launching.EquinoxLaunchConfiguration
 */
public class EquinoxLaunchConfiguration extends AbstractPDELaunchConfiguration {
	...
	private void saveConfigurationFile(ILaunchConfiguration configuration) throws CoreException {
		...
		int start = configuration.getAttribute(com.siteview.mde.launching.IPDELauncherConstants.DEFAULT_START_LEVEL, 4);
		properties.put("osgi.bundles.defaultStartLevel", Integer.toString(start)); //$NON-NLS-1$
		boolean autostart = configuration.getAttribute(com.siteview.mde.launching.IPDELauncherConstants.DEFAULT_AUTO_START, true);
		...
		if (fAllBundles.containsKey(IPDEBuildConstants.BUNDLE_SIMPLE_CONFIGURATOR)) {
			...
			IMonitorModelBase model = (IMonitorModelBase) fAllBundles.get(IPDEBuildConstants.BUNDLE_SIMPLE_CONFIGURATOR);
	...
	/*
	 * (non-Javadoc)
	 * @see com.siteview.mde.ui.launcher.AbstractPDELaunchConfiguration#validatePluginDependencies(org.eclipse.debug.core.ILaunchConfiguration, org.eclipse.core.runtime.IProgressMonitor)
	 */
