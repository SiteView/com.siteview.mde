...
public class OSGiLaunchShortcut extends AbstractLaunchShortcut {
	...
	/*
	 * (non-Javadoc)
	 * @see com.siteview.mde.ui.launcher.AbstractLaunchShortcut#getLaunchConfigurationTypeName()
	 */
	 ...
	 * <p>
	 * Refer to the <code>com.siteview.mde.ui.osgiFrameworks</code> extension point.
	 * </p>
	 * @see com.siteview.mde.ui.launcher.AbstractLaunchShortcut#initializeConfiguration(org.eclipse.debug.core.ILaunchConfigurationWorkingCopy)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see com.siteview.mde.ui.launcher.AbstractLaunchShortcut#isGoodMatch(org.eclipse.debug.core.ILaunchConfiguration)
	 */
