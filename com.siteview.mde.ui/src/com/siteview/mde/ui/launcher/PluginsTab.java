...
public class PluginsTab extends AbstractLauncherTab {
	...
	public void createControl(Composite parent) {
		...
		fSelectionCombo = SWTFactory.createCombo(buttonComp, SWT.READ_ONLY | SWT.BORDER, 1, GridData.HORIZONTAL_ALIGN_BEGINNING, new String[] {MDEUIMessages.PluginsTab_allPlugins, MDEUIMessages.PluginsTab_selectedPlugins, MDEUIMessages.PluginsTab_customFeatureMode});
	...
	public String getName() {
		return MDEUIMessages.AdvancedLauncherTab_name;
	}
