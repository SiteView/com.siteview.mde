...
import com.siteview.mde.internal.ui.launcher.ConfigurationAreaBlock;
import com.siteview.mde.internal.ui.launcher.JREBlock;
...
public class OSGiSettingsTab extends AbstractLauncherTab {
	...
	public OSGiSettingsTab() {
		fImage = MDEPluginImages.DESC_SETTINGS_OBJ.createImage();
	...
	public String getName() {
		return MDEUIMessages.EquinoxSettingsTab_name;
	}
	...
	/*
	 * (non-Javadoc)
	 * @see com.siteview.mde.ui.launcher.AbstractLauncherTab#updateLaunchConfigurationDialog()
	 */
