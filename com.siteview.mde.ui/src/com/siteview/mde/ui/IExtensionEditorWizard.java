 ...
 * <samp>com.siteview.mde.ui.newExtension </samp> extension point and want to
...
public interface IExtensionEditorWizard extends IBasePluginWizard {
	 ...
	 *  
	 */
	public void init(IProject project, IMonitorModelBase pluginModel, IStructuredSelection selection);
}
