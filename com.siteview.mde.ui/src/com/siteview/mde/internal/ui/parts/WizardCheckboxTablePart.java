...
public class WizardCheckboxTablePart extends CheckboxTablePart {
	...
	public WizardCheckboxTablePart(String mainLabel) {
		this(mainLabel, new String[] {MDEUIMessages.WizardCheckboxTablePart_selectAll, MDEUIMessages.WizardCheckboxTablePart_deselectAll, MDEUIMessages.WizardCheckboxTablePart_select, MDEUIMessages.WizardCheckboxTablePart_deselect});
		setSelectAllIndex(0);
	...
	protected void updateCounterLabel() {
		...
		String message = NLS.bind(MDEUIMessages.WizardCheckboxTablePart_counter, (new String[] {number, totalNumber}));
