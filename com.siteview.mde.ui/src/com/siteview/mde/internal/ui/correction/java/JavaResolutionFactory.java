...
public class JavaResolutionFactory {
	...
	private static class RequireBundleManifestChange extends AbstractManifestChange {
		...
		public Image getImage() {
			return MDEPlugin.getDefault().getLabelProvider().get(MDEPluginImages.DESC_REQ_PLUGIN_OBJ);
		}
		...
		public String getDescription() {
			return MDEUIMessages.UnresolvedImportFixProcessor_2;
		}
		...
		public String getName() {
			if (!isUndo()) {
				return MessageFormat.format(MDEUIMessages.UnresolvedImportFixProcessor_0, new Object[] {((ExportPackageDescription) getChangeObject()).getExporter().getName()});
			}
			return MessageFormat.format(MDEUIMessages.UnresolvedImportFixProcessor_1, new Object[] {((ExportPackageDescription) getChangeObject()).getExporter().getName()});
		}
	...
	private static class ImportPackageManifestChange extends AbstractManifestChange {
		 ...
		 */
		public String getDescription() {
			return MDEUIMessages.UnresolvedImportFixProcessor_5;
		}
		 ...
		 */
		public Image getImage() {
			return MDEPlugin.getDefault().getLabelProvider().get(MDEPluginImages.DESC_BUNDLE_OBJ);
		}
		...
		public String getName() {
			if (!isUndo()) {
				return MessageFormat.format(MDEUIMessages.UnresolvedImportFixProcessor_3, new Object[] {((ExportPackageDescription) getChangeObject()).getName()});
			}
			return MessageFormat.format(MDEUIMessages.UnresolvedImportFixProcessor_4, new Object[] {((ExportPackageDescription) getChangeObject()).getName()});
		}
	...
	private static class ExportPackageChange extends AbstractManifestChange {
		 ...
		 */
		public String getName() {
			return NLS.bind(MDEUIMessages.ForbiddenAccessProposal_quickfixMessage, new String[] {((IPackageFragment) getChangeObject()).getElementName(), getProject().getName()});
		}
		 ...
		 */
		public Image getImage() {
			return MDEPluginImages.get(MDEPluginImages.OBJ_DESC_BUNDLE);
		}
