...
public class NoLineTerminationResolution extends AbstractManifestMarkerResolution {
	...
	public String getDescription() {
		if (getType() == AbstractPDEMarkerResolution.REMOVE_TYPE) {
			return MDEUIMessages.NoLineTerminationResolutionRemove_description;
		}
		return MDEUIMessages.NoLineTerminationResolutionCreate_description;
	}

	public String getLabel() {
		if (getType() == AbstractPDEMarkerResolution.REMOVE_TYPE) {
			return MDEUIMessages.NoLineTerminationResolutionRemove_label;
		}
		return MDEUIMessages.NoLineTerminationResolutionCreate_label;
	}
