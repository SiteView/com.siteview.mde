...
public class OptionalRequireBundleResolution extends AbstractManifestMarkerResolution {
	...
	public String getDescription() {
		return NLS.bind(MDEUIMessages.OptionalRequireBundleResolution_description, fBundleId);
	}

	public String getLabel() {
		return NLS.bind(MDEUIMessages.OptionalRequireBundleResolution_label, fBundleId);
	}
