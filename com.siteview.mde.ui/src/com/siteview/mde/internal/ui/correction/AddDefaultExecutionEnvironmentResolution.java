...
import com.siteview.mde.internal.core.text.bundle.RequiredExecutionEnvironmentHeader;
...
public class AddDefaultExecutionEnvironmentResolution extends AbstractManifestMarkerResolution {
	...
	public String getLabel() {
		return NLS.bind(MDEUIMessages.AddDefaultExecutionEnvironment_label, id);
	}
}
