...
import com.siteview.mde.internal.core.builders.MDEBuilderHelper;
...
public class AddSourceBuildEntryResolution extends BuildEntryMarkerResolution {
	...
	public String getLabel() {
		return NLS.bind(MDEUIMessages.AddSourceBuildEntryResolution_label, fEntry);
	}
	...
	private String[] getSourcePaths(Build build, boolean unlistedOnly) {
		...
		try {
			if (project.hasNature(JavaCore.NATURE_ID)) {
				...
				return MDEBuilderHelper.getUnlistedClasspaths(sourceEntries, project, cpes);
			}
