...
public class AboutSection extends MDESection {
	...
	public AboutSection(MDEFormPage page, Composite parent) {
	...
	protected void createClient(Section section, FormToolkit toolkit) {
		...
		section.setText(MDEUIMessages.AboutSection_title);
		section.setDescription(MDEUIMessages.AboutSection_desc);
		...
		fImageEntry = new FormEntry(client, toolkit, MDEUIMessages.AboutSection_image, MDEUIMessages.AboutSection_browse, isEditable());
		...
		fTextEntry = new FormEntry(client, toolkit, MDEUIMessages.AboutSection_text, style);
	...
	private void handleBrowse() {
		...
		dialog.setTitle(MDEUIMessages.AboutSection_imgTitle);
		dialog.setMessage(MDEUIMessages.AboutSection_imgMessage);
