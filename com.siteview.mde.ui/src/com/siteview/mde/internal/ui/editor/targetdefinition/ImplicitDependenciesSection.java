...
public class ImplicitDependenciesSection extends SectionPart {
	...
	protected void createClient(Section section, FormToolkit toolkit) {
		...
		section.setText(MDEUIMessages.ImplicitDependenicesSection_Title);
		section.setDescription(MDEUIMessages.TargetImplicitPluginsTab_desc);
	...
	private void createButtons(FormToolkit toolkit, Composite parent) {
		fAdd = toolkit.createButton(parent, MDEUIMessages.ImplicitDependenicesSection_Add, SWT.PUSH);
		...
		fRemove = toolkit.createButton(parent, MDEUIMessages.ImplicitDependenicesSection_Remove, SWT.PUSH);
		...
		fRemoveAll = toolkit.createButton(parent, MDEUIMessages.ImplicitDependenicesSection_RemoveAll, SWT.PUSH);
	...
	private void updateCount() {
		if (fCount != null && !fCount.isDisposed())
			fCount.setText(NLS.bind(MDEUIMessages.TableSection_itemCount, Integer.toString(fViewer.getTable().getItemCount())));
	}
