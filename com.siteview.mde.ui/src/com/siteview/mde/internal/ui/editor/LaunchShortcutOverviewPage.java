...
public abstract class LaunchShortcutOverviewPage extends MDEFormPage implements IHyperlinkListener {

	public LaunchShortcutOverviewPage(MDELauncherFormEditor editor, String id, String title) {
	...
	protected MDELauncherFormEditor getPDELauncherEditor() {
		return (MDELauncherFormEditor) getMDEEditor();
	}
}
