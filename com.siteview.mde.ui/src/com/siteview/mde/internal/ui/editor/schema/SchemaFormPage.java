...
public class SchemaFormPage extends MDEFormPage implements IModelChangedListener {
	...
	public class SchemaBlock extends MDEMasterDetailsBlock implements IDetailsPageProvider {
	...
	public SchemaFormPage(MDEFormEditor editor) {
		super(editor, PAGE_ID, MDEUIMessages.SchemaEditor_FormPage_title);
	...
	private void createUIImageHyperlinkPreviewRefDoc(Composite parent) {
		...
		fImageHyperlinkPreviewRefDoc.setText(MDEUIMessages.SchemaEditor_previewLink);
