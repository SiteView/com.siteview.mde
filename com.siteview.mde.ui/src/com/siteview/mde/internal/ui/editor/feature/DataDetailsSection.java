...
public class DataDetailsSection extends MDESection implements IFormPart, IPartSelectionListener {
	...
	public DataDetailsSection(MDEFormPage page, Composite parent) {
		this(page, parent, MDEUIMessages.SiteEditor_DataDetailsSection_title, MDEUIMessages.SiteEditor_DataDetailsSection_desc, SWT.NULL);
	}

	public DataDetailsSection(MDEFormPage page, Composite parent, String title, String desc, int toggleStyle) {
	...
	public void createClient(Section section, FormToolkit toolkit) {
		...
		fdownloadSizeText = new FormEntry(container, toolkit, MDEUIMessages.SiteEditor_DataDetailsSection_downloadSize, null, false);
		...
		fInstallSizeText = new FormEntry(container, toolkit, MDEUIMessages.SiteEditor_DataDetailsSection_installSize, null, false);
