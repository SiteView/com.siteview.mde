...
import com.siteview.mde.internal.ui.search.PreviewReferenceAction;
...
public class SchemaPreviewLauncher implements IEditorLauncher {
	...
	private void handleUnsavedOpenSchemaEditor(IFile file) {
		...
		// editor
		boolean doSave = MessageDialog.openQuestion(Display.getDefault().getActiveShell(), MDEUIMessages.SchemaPreviewLauncher_msgEditorHasUnsavedChanges, MDEUIMessages.SchemaPreviewLauncher_msgSaveChanges);
