...
public class IncludedFeaturesDetailsSection extends MDESection implements IFormPart, IPartSelectionListener {
	...
	public IncludedFeaturesDetailsSection(MDEFormPage page, Composite parent) {
		this(page, parent, MDEUIMessages.SiteEditor_IncludedFeaturesDetailsSection_title, MDEUIMessages.SiteEditor_IncludedFeaturesDetailsSection_desc, SWT.NULL);
	}

	public IncludedFeaturesDetailsSection(MDEFormPage page, Composite parent, String title, String desc, int toggleStyle) {
	...
	public void createClient(Section section, FormToolkit toolkit) {
		...
		fNameText = new FormEntry(container, toolkit, MDEUIMessages.SiteEditor_IncludedFeaturesDetailsSection_featureLabel, null, false);
		...
		fOptionalButton = toolkit.createButton(container, MDEUIMessages.SiteEditor_IncludedFeaturesDetailsSection_optional, SWT.CHECK);
		...
		Label fSearchLocationDescLabel = toolkit.createLabel(container, MDEUIMessages.SiteEditor_IncludedFeaturesDetailsSection_searchLocation, SWT.WRAP);
		gd = new TableWrapData(TableWrapData.FILL);
		gd.colspan = 2;
		fSearchLocationDescLabel.setLayoutData(gd);

		fSearchRootButton = toolkit.createButton(container, MDEUIMessages.SiteEditor_IncludedFeaturesDetailsSection_root, SWT.RADIO);
		...
		fSearchSelfButton = toolkit.createButton(container, MDEUIMessages.SiteEditor_IncludedFeaturesDetailsSection_self, SWT.RADIO);
		...
		fSearchBothButton = toolkit.createButton(container, MDEUIMessages.SiteEditor_IncludedFeaturesDetailsSection_both, SWT.RADIO);
