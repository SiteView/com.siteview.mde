...
public class IncludedFeaturesSection extends TableSection implements IFeatureModelListener, IPropertyChangeListener {
	...
	public IncludedFeaturesSection(MDEFormPage page, Composite parent) {
		super(page, parent, Section.DESCRIPTION, new String[] {MDEUIMessages.FeatureEditor_IncludedFeatures_new, MDEUIMessages.FeatureEditor_IncludedFeatures_up, MDEUIMessages.FeatureEditor_IncludedFeatures_down});
		getSection().setText(MDEUIMessages.FeatureEditor_IncludedFeatures_title);
		getSection().setDescription(MDEUIMessages.FeatureEditor_IncludedFeatures_desc);
	...
	public void createClient(Section section, FormToolkit toolkit) {
		...
		fIncludesViewer.setLabelProvider(MDEPlugin.getDefault().getLabelProvider());
	...
	private void createSectionToolbar(Section section, FormToolkit toolkit) {
		...
		fSortAction = new SortAction(getStructuredViewerPart().getViewer(), MDEUIMessages.FeatureEditor_IncludedFeatures_sortAlpha, ListUtil.NAME_COMPARATOR, null, this);
