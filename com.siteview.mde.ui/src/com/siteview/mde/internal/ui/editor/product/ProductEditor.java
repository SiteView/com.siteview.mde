...
public class ProductEditor extends MDELauncherFormEditor {
	...
	protected String getEditorID() {
		return IMDEUIConstants.PRODUCT_EDITOR_ID;
	}
	...
	private ProductExportAction getExportAction() {
		if (fExportAction == null) {
			...
			fExportAction.setToolTipText(MDEUIMessages.ProductEditor_exportTooltip);
			fExportAction.setImageDescriptor(MDEPluginImages.DESC_EXPORT_PRODUCT_TOOL);
		}
