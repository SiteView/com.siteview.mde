...
public class MDEDropAdapter extends ViewerDropAdapter {

	private IMDEDropParticipant fDropParticipant;

	private IMDESourceParticipant fSourceParticipant;

	private int fLastValidOperation;

	public MDEDropAdapter(Viewer viewer, IMDEDropParticipant dropParticipant, IMDESourceParticipant sourceParticipant) {
		super(viewer);
