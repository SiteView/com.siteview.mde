...
public class InstallSection extends MDESection {
	...
	public InstallSection(FeatureAdvancedPage page, Composite parent) {
		...
		getSection().setText(MDEUIMessages.FeatureEditor_InstallSection_title);
		getSection().setDescription(MDEUIMessages.FeatureEditor_InstallSection_desc);
	...
	public void createClient(Section section, FormToolkit toolkit) {
		...
		fExclusiveButton = toolkit.createButton(container, MDEUIMessages.FeatureEditor_InstallSection_exclusive, SWT.CHECK);
		...
		Label colocationDescLabel = toolkit.createLabel(container, MDEUIMessages.FeatureEditor_InstallSection_colocation_desc, SWT.WRAP);
		gd = new GridData(GridData.FILL);
		gd.horizontalSpan = 2;
		gd.widthHint = 250;
		colocationDescLabel.setLayoutData(gd);

		fColocationText = new FormEntry(container, toolkit, MDEUIMessages.FeatureEditor_InstallSection_colocation, null, false);
