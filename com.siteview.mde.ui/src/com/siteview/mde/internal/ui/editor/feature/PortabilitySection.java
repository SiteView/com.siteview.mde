...
public class PortabilitySection extends MDESection {
	...
	public PortabilitySection(FeatureFormPage page, Composite parent) {
		this(page, parent, MDEUIMessages.FeatureEditor_PortabilitySection_title, MDEUIMessages.FeatureEditor_PortabilitySection_desc, SWT.NULL);
	}
	...
	public void createClient(Section section, FormToolkit toolkit) {
		...
		String editLabel = MDEUIMessages.FeatureEditor_PortabilitySection_edit;

		fOsText = new FormEntry(container, toolkit, MDEUIMessages.FeatureEditor_PortabilitySection_os, editLabel, false);
		...
		fWsText = new FormEntry(container, toolkit, MDEUIMessages.FeatureEditor_PortabilitySection_ws, editLabel, false);
		...
		fNlText = new FormEntry(container, toolkit, MDEUIMessages.FeatureEditor_PortabilitySection_nl, editLabel, false);
		...
		fArchText = new FormEntry(container, toolkit, MDEUIMessages.FeatureEditor_PortabilitySection_arch, editLabel, false);
	...
	private void openPortabilityChoiceDialog(String property, FormEntry text, Choice[] choices) {
		...
		dialog.create();
		dialog.getShell().setText(MDEUIMessages.FeatureEditor_PortabilityChoicesDialog_title);
