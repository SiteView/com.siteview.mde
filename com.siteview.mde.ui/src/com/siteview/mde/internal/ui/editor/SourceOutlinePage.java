 ...
 */
public class SourceOutlinePage extends MDEOutlinePage implements IReconcilingParticipant, ISortableContentOutlinePage {
	...
	public SourceOutlinePage(MDEFormEditor editor, IEditingModel model, IBaseLabelProvider lProvider, IContentProvider cProvider, ViewerComparator defaultComparator, ViewerComparator comparator) {
		super(editor);
		fModel = model;
