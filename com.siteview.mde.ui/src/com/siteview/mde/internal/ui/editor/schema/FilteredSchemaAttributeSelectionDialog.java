...
public class FilteredSchemaAttributeSelectionDialog extends FilteredItemsSelectionDialog {
	...
	private static final String DIALOG_SETTINGS = "com.siteview.mde.ui.dialogs.FilteredSchemaAttributeSelectionDialog"; //$NON-NLS-1$
	...
	private class ShowOptionalAttributesAction extends Action {
		...
		public ShowOptionalAttributesAction() {
			super(MDEUIMessages.FilteredSchemaAttributeSelectionDialog_showOptionalAttributes, IAction.AS_CHECK_BOX);
			setChecked(true);
		}
	...
	public FilteredSchemaAttributeSelectionDialog(Shell shell) {
		...
		setTitle(MDEUIMessages.FilteredSchemaAttributeSelectionDialog_title);
		setMessage(MDEUIMessages.FilteredSchemaAttributeSelectionDialog_message);
	...
	private class SchemaDetailsLabelProvider extends LabelProvider {
		...
		public Image getImage(Object element) {
			return MDEPlugin.getDefault().getLabelProvider().get(MDEPluginImages.DESC_EXT_POINT_OBJ);
		}
