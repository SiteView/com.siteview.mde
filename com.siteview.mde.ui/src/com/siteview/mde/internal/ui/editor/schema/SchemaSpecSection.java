...
public class SchemaSpecSection extends MDESection {
	...
	public SchemaSpecSection(SchemaOverviewPage page, Composite parent) {
		...
		getSection().setText(MDEUIMessages.SchemaEditor_SpecSection_title);
		getSection().setDescription(MDEUIMessages.SchemaEditor_SpecSection_desc);
	...
	public void createClient(Section section, FormToolkit toolkit) {
		...
		fPluginText = new FormEntry(container, toolkit, MDEUIMessages.SchemaEditor_SpecSection_plugin, null, false);
		fPluginText.setFormEntryListener(new FormEntryAdapter(this) {
			public void textValueChanged(FormEntry text) {
				schema.setPluginId(text.getValue());
			}
		});
		fPointText = new FormEntry(container, toolkit, MDEUIMessages.SchemaEditor_SpecSection_point, null, false);
		fPointText.setFormEntryListener(new FormEntryAdapter(this) {
			public void textValueChanged(FormEntry text) {
				schema.setPointId(text.getValue());
			}
		});
		fNameText = new FormEntry(container, toolkit, MDEUIMessages.SchemaEditor_SpecSection_name, null, false);
