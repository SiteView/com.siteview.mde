...
import com.siteview.mde.internal.core.converter.MDEMonitorConverter;
...
public class CreateManifestOperation implements IRunnableWithProgress {
	...
	private void handleConvert() throws CoreException {
		...
		MDEMonitorConverter.convertToOSGIFormat(project, target, ClasspathHelper.getDevDictionary(fModel), new NullProgressMonitor());
	}
