...
import com.siteview.mde.internal.ui.editor.text.ChangeAwareSourceViewerConfiguration;
 ...
 *
 */
public class MDEProjectionViewer extends ProjectionViewer {
	 ...
	 * @param styles
	 */
	public MDEProjectionViewer(Composite parent, IVerticalRuler ruler, IOverviewRuler overviewRuler, boolean showsAnnotationOverview, int styles, boolean isQuickOutlineEnabled) {
