...
public class FeatureAdvancedPage extends MDEFormPage {
	...
	public FeatureAdvancedPage(MDEFormEditor editor, String title) {
	...
	protected void createFormContent(IManagedForm managedForm) {
		...
		form.setImage(MDEPlugin.getDefault().getLabelProvider().get(MDEPluginImages.DESC_OPERATING_SYSTEM_OBJ));
		...
		form.setText(MDEUIMessages.FeatureEditor_AdvancedPage_heading);
