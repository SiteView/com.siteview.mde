...
public class SchemaOverviewPage extends MDEFormPage {
	...
	public SchemaOverviewPage(MDEFormEditor editor) {
		super(editor, PAGE_ID, MDEUIMessages.SchemaEditor_DocPage_title);
	}
