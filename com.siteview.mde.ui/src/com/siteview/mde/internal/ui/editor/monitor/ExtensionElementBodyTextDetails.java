...
public class ExtensionElementBodyTextDetails extends AbstractPluginElementDetails implements IControlHoverContentProvider {
	...
	private IMonitorElement fPluginElement;
	...
	public ExtensionElementBodyTextDetails(MDESection masterSection) {
		super(masterSection);
		fPluginElement = null;
		fSchemaElement = null;
		fTextBody = null;
	...
	private void createUIHyperlinkBody(Composite client) {
		fHyperlinkBody = fToolkit.createHyperlink(client, MDEUIMessages.ExtensionElementBodyTextDetails_labelBodyText, SWT.NULL);
	}
	...
	private void createUISectionElementDetails(Composite parent) {
		...
		fSectionElementDetails.setText(MDEUIMessages.ExtensionElementDetails_title);
		fSectionElementDetails.setDescription(MDEUIMessages.ExtensionElementBodyTextDetails_sectionDescElementGeneral);
	...
	private void updateUISectionElementDetails() {
		...
		if (fPluginElement == null) {
			...
			fSectionElementDetails.setDescription(NLS.bind(MDEUIMessages.ExtensionElementBodyTextDetails_sectionDescElementSpecific, fPluginElement.getName()));
		}
