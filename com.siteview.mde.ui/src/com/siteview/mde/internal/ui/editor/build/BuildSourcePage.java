...
import com.siteview.mde.internal.ui.editor.KeyValueSourcePage;
...
public class BuildSourcePage extends KeyValueSourcePage {
	...
	class BuildLabelProvider extends LabelProvider {
		...
		public Image getImage(Object obj) {
			if (obj instanceof IBuildEntry)
				return MDEPlugin.getDefault().getLabelProvider().get(MDEPluginImages.DESC_BUILD_VAR_OBJ);
			return null;
		}
	}

	public BuildSourcePage(MDEFormEditor editor, String id, String title) {
