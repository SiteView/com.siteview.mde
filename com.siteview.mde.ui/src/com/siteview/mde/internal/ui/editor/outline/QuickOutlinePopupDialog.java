...
public class QuickOutlinePopupDialog extends PopupDialog implements IInformationControl, IInformationControlExtension, IInformationControlExtension2, DisposeListener {
	...
	private void initialize() {
		setInfoText(MDEUIMessages.QuickOutlinePopupDialog_infoTextPressEscToExit);
	...
	private void createUIActions() {
		...
		fSortAction = new SortAction(fTreeViewer, MDEUIMessages.PDEMultiPageContentOutline_SortingAction_tooltip, fTreeViewerComparator, fTreeViewerDefaultComparator, null);
	}
