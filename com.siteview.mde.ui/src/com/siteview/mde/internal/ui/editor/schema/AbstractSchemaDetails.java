...
import com.siteview.mde.internal.core.ischema.ISchemaCompositor;
...
public abstract class AbstractSchemaDetails extends MDEDetails {
	...
	public final void createContents(Composite parent) {
		...
		GC gc = new GC(parent);
		minLabelWeight = gc.textExtent(MDEUIMessages.SchemaDetails_translatable).x + 11;
		gc.dispose();
		gc = null;
	...
	private void createDescription(Composite container, FormToolkit toolkit) {
		...
		Label label = toolkit.createLabel(container, MDEUIMessages.AbstractSchemaDetails_descriptionLabel);
	...
	protected Composite createMinOccurComp(Composite parent, FormToolkit toolkit) {
		fMinLabel = toolkit.createLabel(parent, MDEUIMessages.AbstractSchemaDetails_minOccurLabel);
	...
	protected Composite createMaxOccurComp(Composite parent, FormToolkit toolkit) {
		fMaxLabel = toolkit.createLabel(parent, MDEUIMessages.AbstractSchemaDetails_maxOccurLabel);
		...
		fUnboundSelect = toolkit.createButton(comp, MDEUIMessages.AbstractSchemaDetails_unboundedButton, SWT.CHECK);
		gd = new GridData();
