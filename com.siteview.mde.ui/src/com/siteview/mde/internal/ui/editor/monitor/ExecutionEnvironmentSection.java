...
public class ExecutionEnvironmentSection extends TableSection {
	...
	public ExecutionEnvironmentSection(MDEFormPage page, Composite parent) {
		super(page, parent, Section.DESCRIPTION, new String[] {MDEUIMessages.RequiredExecutionEnvironmentSection_add, MDEUIMessages.RequiredExecutionEnvironmentSection_remove, MDEUIMessages.RequiredExecutionEnvironmentSection_up, MDEUIMessages.RequiredExecutionEnvironmentSection_down});
		createClient(getSection(), page.getEditor().getToolkit());
	}

	protected void createClient(Section section, FormToolkit toolkit) {
		section.setText(MDEUIMessages.RequiredExecutionEnvironmentSection_title);
		if (isFragment())
			section.setDescription(MDEUIMessages.RequiredExecutionEnvironmentSection_fragmentDesc);
		else
			section.setDescription(MDEUIMessages.RequiredExecutionEnvironmentSection_pluginDesc);
	...
	private void makeActions() {
		fAddAction = new Action(MDEUIMessages.RequiredExecutionEnvironmentSection_add) {
			public void run() {
				handleAdd();
			}
		};
	...
	private void handleAdd() {
		...
		dialog.setTitle(MDEUIMessages.RequiredExecutionEnvironmentSection_dialog_title);
