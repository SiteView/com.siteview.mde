...
public class DefinitionPage extends FormPage implements IHyperlinkListener {
	...
	public DefinitionPage(TargetEditor editor) {
		super(editor, PAGE_ID, MDEUIMessages.DefinitionPage_0);
	}
	...
	protected void createFormContent(IManagedForm managedForm) {
		...
		form.setText(MDEUIMessages.DefinitionPage_1);
	...
	private void createContentsSection(Composite parent, FormToolkit toolkit) {
		Section section = createSection(parent, toolkit, MDEUIMessages.OverviewPage_contentTitle);
		createText(section, MDEUIMessages.OverviewPage_contentDescription, toolkit);
	}

	private void createEnvironmentSection(Composite parent, FormToolkit toolkit) {
		Section section = createSection(parent, toolkit, MDEUIMessages.OverviewPage_environmentTitle);
		createText(section, MDEUIMessages.OverviewPage_environmentDescription, toolkit);
	}
