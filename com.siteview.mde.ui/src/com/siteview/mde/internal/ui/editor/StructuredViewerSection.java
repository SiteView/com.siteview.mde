...
public abstract class StructuredViewerSection extends MDESection implements IMDEDragParticipant, IMDEDropParticipant {

	protected StructuredViewerPart fViewerPart;

	private boolean fDoSelection;

	private MDEDragAdapter fDragAdapter;

	private MDEDropAdapter fDropAdapter;

	/**
	 * Constructor for StructuredViewerSection.
	 * @param formPage
	 */
	public StructuredViewerSection(MDEFormPage formPage, Composite parent, int style, String[] buttonLabels) {
	 ...
	 * @param formPage
	 */
	public StructuredViewerSection(MDEFormPage formPage, Composite parent, int style, boolean titleBar, String[] buttonLabels) {
