...
public class URLDetailsSection extends MDESection implements IPartSelectionListener {
	...
	public URLDetailsSection(MDEFormPage page, Composite parent) {
		super(page, parent, Section.DESCRIPTION | ExpandableComposite.NO_TITLE, false);
		getSection().setDescription(MDEUIMessages.FeatureEditor_URLDetailsSection_desc);
	...
	public void createClient(Section section, FormToolkit toolkit) {
		...
		fUrlText = new FormEntry(container, toolkit, MDEUIMessages.FeatureEditor_URLDetailsSection_updateUrl, null, false);
		...
		fNameText = new FormEntry(container, toolkit, MDEUIMessages.FeatureEditor_URLDetailsSection_updateUrlLabel, null, false);
	...
	private void warnBadUrl(String text) {
		MessageDialog.openError(MDEPlugin.getActiveWorkbenchShell(), MDEUIMessages.FeatureEditor_URLDetailsSection_badUrlTitle, MDEUIMessages.FeatureEditor_URLDetailsSection_badUrlMessage);
	}
