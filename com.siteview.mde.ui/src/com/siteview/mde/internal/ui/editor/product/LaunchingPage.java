...
public class LaunchingPage extends MDEFormPage {

	public static final String PAGE_ID = "launcher"; //$NON-NLS-1$

	public LaunchingPage(FormEditor editor) {
		super(editor, PAGE_ID, MDEUIMessages.LauncherPage_title);
	}
	...
	protected void createFormContent(IManagedForm managedForm) {
		...
		form.setImage(MDEPlugin.getDefault().getLabelProvider().get(MDEPluginImages.DESC_PRODUCT_LAUNCHING));
		form.setText(MDEUIMessages.LauncherPage_title);
