...
public class HandlerSection extends MDESection {
	...
	public HandlerSection(FeatureAdvancedPage page, Composite parent) {
		...
		getSection().setText(MDEUIMessages.FeatureEditor_HandlerSection_title);
		getSection().setDescription(MDEUIMessages.FeatureEditor_HandlerSection_desc);
	...
	public void createClient(Section section, FormToolkit toolkit) {
		...
		fLibraryText = new FormEntry(container, toolkit, MDEUIMessages.FeatureEditor_HandlerSection_library, null, false);
		...
		fHandlerText = new FormEntry(container, toolkit, MDEUIMessages.FeatureEditor_HandlerSection_handler, null, false);
