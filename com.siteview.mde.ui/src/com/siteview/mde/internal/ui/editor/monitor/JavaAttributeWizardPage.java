...
public class JavaAttributeWizardPage extends NewClassWizardPage {
	...
	public JavaAttributeWizardPage(IProject project, IMonitorModelBase model, ISchemaAttribute attInfo, String className) {
		super();
	...
	private void initializeExpectedValues() {
		...
		try {
			...
			if (attInfo == null) {
				...
				IEclipsePreferences prefs = new ProjectScope(project).getNode(MDECore.PLUGIN_ID);
