 ...
 * 
 */
public class FeatureIncludesPage extends MDEFormPage {
	 ...
	 * @param title
	 */
	public FeatureIncludesPage(MDEFormEditor editor, String title) {
	...
	protected void createFormContent(IManagedForm managedForm) {
		...
		form.setText(MDEUIMessages.FeatureEditor_IncludesPage_heading);
