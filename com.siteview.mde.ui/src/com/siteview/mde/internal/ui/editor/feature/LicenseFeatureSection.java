...
import com.siteview.mde.internal.ui.editor.text.XMLConfiguration;
 ...
 * @see FeatureEditor
 */
public class LicenseFeatureSection extends MDESection {
	...
	public LicenseFeatureSection(MDEFormPage page, Composite parent, XMLConfiguration fSourceConfiguration) {
	...
	public void createClient(Section section, FormToolkit toolkit) {
		...
		fSharedLicenseButton = toolkit.createButton(page, MDEUIMessages.FeatureEditor_licenseFeatureSection_sharedButton, SWT.RADIO);
		fLocalLicenseButton = toolkit.createButton(page, MDEUIMessages.FeatureEditor_licenseFeatureSection_localButton, SWT.RADIO);
		...
		Label label = toolkit.createLabel(licenseFeatureComposite, MDEUIMessages.FeatureEditor_licenseFeatureSection_featureID);
		...
		fLicenseButton = toolkit.createButton(licenseFeatureComposite, MDEUIMessages.FeatureEditor_licenseFeatureSection_browse, SWT.PUSH);
		...
		label = toolkit.createLabel(licenseFeatureComposite, MDEUIMessages.FeatureEditor_licenseFeatureSection_featureVersion);
		label.setForeground(toolkit.getColors().getColor(IFormColors.TITLE));
