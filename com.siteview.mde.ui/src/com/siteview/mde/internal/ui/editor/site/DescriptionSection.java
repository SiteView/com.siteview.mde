 ...
 * 
 */
public class DescriptionSection extends MDESection {

	private FormEntry fNameEntry;
	private FormEntry fURLEntry;
	private FormEntry fDescEntry;

	public DescriptionSection(MDEFormPage page, Composite parent) {
		super(page, parent, Section.DESCRIPTION);
		getSection().setText(MDEUIMessages.SiteEditor_DescriptionSection_header);
		getSection().setDescription(MDEUIMessages.SiteEditor_DescriptionSection_desc);
	...
	public void createClient(Section section, FormToolkit toolkit) {
		...
		fNameEntry = new FormEntry(container, toolkit, MDEUIMessages.DescriptionSection_nameLabel, null, false);
		...
		fURLEntry = new FormEntry(container, toolkit, MDEUIMessages.SiteEditor_DescriptionSection_urlLabel, null, false);
		...
		fDescEntry = new FormEntry(container, toolkit, MDEUIMessages.SiteEditor_DescriptionSection_descLabel, SWT.WRAP | SWT.MULTI);
