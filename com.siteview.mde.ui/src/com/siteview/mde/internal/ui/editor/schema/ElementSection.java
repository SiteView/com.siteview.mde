...
public class ElementSection extends TreeSection {
	...
	public ElementSection(MDEFormPage page, Composite parent) {
		super(page, parent, Section.DESCRIPTION, new String[] {MDEUIMessages.SchemaEditor_ElementSection_newElement, MDEUIMessages.SchemaEditor_ElementSection_newAttribute, MDEUIMessages.SchemaEditor_ElementSection_newChoice, MDEUIMessages.SchemaEditor_ElementSection_newSequence, MDEUIMessages.SchemaEditor_ElementSection_remove});
	...
	protected void handleDoubleClick(IStructuredSelection selection) {
		...
		if (object instanceof SchemaElementReference) {
			...
			if (element == null) {
				...
				MessageDialog.openWarning(getPage().getSite().getShell(), MDEUIMessages.ElementSection_missingRefElement, NLS.bind(MDEUIMessages.SchemaIncludesSection_missingWarningMessage, name));
				return;
			}
