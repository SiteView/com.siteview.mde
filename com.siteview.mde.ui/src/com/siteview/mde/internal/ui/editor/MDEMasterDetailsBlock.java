...
public abstract class MDEMasterDetailsBlock extends MasterDetailsBlock {
	private MDEFormPage fPage;
	private MDESection fSection;

	public MDEMasterDetailsBlock(MDEFormPage page) {
		fPage = page;
	}
	...
	protected abstract MDESection createMasterSection(IManagedForm managedForm, Composite parent);
