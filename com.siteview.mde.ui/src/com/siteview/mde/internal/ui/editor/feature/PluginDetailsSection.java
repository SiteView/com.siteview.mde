...
public class PluginDetailsSection extends MDESection implements IFormPart, IPartSelectionListener {
	...
	public PluginDetailsSection(MDEFormPage page, Composite parent) {
		this(page, parent, MDEUIMessages.SiteEditor_PluginDetailsSection_title, MDEUIMessages.SiteEditor_PluginDetailsSection_desc, SWT.NULL);
	}

	public PluginDetailsSection(MDEFormPage page, Composite parent, String title, String desc, int toggleStyle) {
	...
	public void createClient(Section section, FormToolkit toolkit) {
		...
		fNameText = new FormEntry(container, toolkit, MDEUIMessages.SiteEditor_PluginDetailsSection_pluginLabel, null, false);
		...
		fdownloadSizeText = new FormEntry(container, toolkit, MDEUIMessages.SiteEditor_PluginDetailsSection_downloadSize, null, false);
		...
		fInstallSizeText = new FormEntry(container, toolkit, MDEUIMessages.SiteEditor_PluginDetailsSection_installSize, null, false);
		...
		fUnpackButton = toolkit.createButton(container, MDEUIMessages.SiteEditor_PluginDetailsSection_unpack, SWT.CHECK);
