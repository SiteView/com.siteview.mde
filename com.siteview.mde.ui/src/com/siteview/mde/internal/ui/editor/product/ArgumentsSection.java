...
public class ArgumentsSection extends MDESection {

	private static final String[] TAB_LABELS = new String[5];
	static {
		TAB_LABELS[IArgumentsInfo.L_ARGS_ALL] = MDEUIMessages.ArgumentsSection_allPlatforms;
	...
	public ArgumentsSection(MDEFormPage page, Composite parent) {
	...
	protected void createClient(Section section, FormToolkit toolkit) {
		...
		section.setText(MDEUIMessages.ArgumentsSection_title);
		section.setDescription(MDEUIMessages.ArgumentsSection_desc);
		...
		fProgramArgs = new FormEntry(client, toolkit, MDEUIMessages.ArgumentsSection_program, SWT.MULTI | SWT.WRAP);
		...
		fVMArgs = new FormEntry(client, toolkit, MDEUIMessages.ArgumentsSection_vm, SWT.MULTI | SWT.WRAP);
