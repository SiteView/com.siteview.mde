...
public class DataPortabilitySection extends MDESection implements IFormPart, IPartSelectionListener {
	...
	public DataPortabilitySection(MDEFormPage page, Composite parent) {
		this(page, parent, MDEUIMessages.FeatureEditor_DataDetailsSection_title, MDEUIMessages.FeatureEditor_DataDetailsSection_desc, SWT.NULL);
	}

	public DataPortabilitySection(MDEFormPage page, Composite parent, String title, String desc, int toggleStyle) {
