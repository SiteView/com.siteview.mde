...
public class FeatureOutlinePage extends FormOutlinePage {
	...
	public FeatureOutlinePage(MDEFormEditor editor) {
		super(editor);
		Image folderImage = MDEPlugin.getDefault().getLabelProvider().get(MDEPluginImages.DESC_DOC_SECTION_OBJ);
		fDiscoveryUrls = new NamedElement(MDEUIMessages.FeatureOutlinePage_discoverUrls, folderImage);
	}
