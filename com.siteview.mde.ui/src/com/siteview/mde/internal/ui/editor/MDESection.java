...
public abstract class MDESection extends SectionPart implements IModelChangedListener, IContextPart, IAdaptable {

	private MDEFormPage fPage;

	public MDESection(MDEFormPage page, Composite parent, int style) {
		this(page, parent, style, true);
	}

	public MDESection(MDEFormPage page, Composite parent, int style, boolean titleBar) {
	...
	protected IProject getProject() {
		return fPage.getMDEEditor().getCommonProject();
	}
