...
public class IncludedFeaturesPortabilitySection extends MDESection implements IFormPart, IPartSelectionListener {
	...
	public IncludedFeaturesPortabilitySection(MDEFormPage page, Composite parent) {
		this(page, parent, MDEUIMessages.FeatureEditor_IncludedFeaturePortabilitySection_title, MDEUIMessages.FeatureEditor_IncludedFeaturePortabilitySection_desc, SWT.NULL);
		getSection().setLayoutData(new GridData(GridData.FILL_HORIZONTAL));
	}

	public IncludedFeaturesPortabilitySection(MDEFormPage page, Composite parent, String title, String desc, int toggleStyle) {
