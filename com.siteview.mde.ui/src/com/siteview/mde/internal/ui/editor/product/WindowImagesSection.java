...
import com.siteview.mde.internal.ui.util.FileExtensionsFilter;
...
public class WindowImagesSection extends MDESection {
	...
	private static final String[] F_ICON_LABELS = new String[] {MDEUIMessages.WindowImagesSection_16, MDEUIMessages.WindowImagesSection_32, MDEUIMessages.WindowImagesSection_48, MDEUIMessages.WindowImagesSection_64, MDEUIMessages.WindowImagesSection_128};
	private FormEntry[] fImages = new FormEntry[F_ICON_LABELS.length];

	public WindowImagesSection(MDEFormPage page, Composite parent) {
	...
	protected void createClient(Section section, FormToolkit toolkit) {
		...
		section.setText(MDEUIMessages.WindowImagesSection_title);
		section.setDescription(MDEUIMessages.WindowImagesSection_desc);
		...
		for (int i = 0; i < fImages.length; i++) {
			final int index = i;
			fImages[index] = new FormEntry(client, toolkit, F_ICON_LABELS[index], MDEUIMessages.WindowImagesSection_browse, isEditable());
	...
	private void handleBrowse(FormEntry entry) {
		...
		dialog.setTitle(MDEUIMessages.WindowImagesSection_dialogTitle);
		dialog.setMessage(MDEUIMessages.WindowImagesSection_dialogMessage);
