...
public class SchemaCompositorDetails extends AbstractSchemaDetails {
	...
	public void createDetails(Composite parent) {
		...
		fKindLabel = toolkit.createLabel(parent, MDEUIMessages.SchemaCompositorDetails_type);
		...
		setText(MDEUIMessages.SchemaCompositorDetails_title);
	}
	...
	public void updateFields(ISchemaObject object) {
		...
		setDecription(NLS.bind(MDEUIMessages.SchemaCompositorDetails_description, fCompositor.getName()));
