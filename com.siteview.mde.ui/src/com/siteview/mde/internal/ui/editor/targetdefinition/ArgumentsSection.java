...
import com.siteview.mde.internal.ui.shared.target.ArgumentsFromContainerSelectionDialog;
...
public class ArgumentsSection extends SectionPart {
	...
	public ArgumentsSection(FormPage page, Composite parent) {
		...
		fImage = MDEPluginImages.DESC_ARGUMENT_TAB.createImage();
	...
	protected void createClient(Section section, FormToolkit toolkit) {
		...
		section.setText(MDEUIMessages.ArgumentsSection_editorTitle);
		section.setDescription(MDEUIMessages.ArgumentsSection_description);
		...
		fProgramArguments = new FormEntry(programComp, toolkit, MDEUIMessages.ArgumentsSection_0, SWT.MULTI | SWT.WRAP);
		...
		Button variables = toolkit.createButton(programComp, MDEUIMessages.ArgumentsSection_variableButtonTitle, SWT.NONE);
		...
		programTab.setText(MDEUIMessages.ArgumentsSection_programTabLabel);
		...
		fVMArguments = new FormEntry(vmComp, toolkit, MDEUIMessages.ArgumentsSection_1, SWT.MULTI | SWT.WRAP);
		...
		Button vmArgs = toolkit.createButton(buttons, MDEUIMessages.ArgumentsSection_argumentsButtonTitle, SWT.NONE);
		...
		variables = toolkit.createButton(buttons, MDEUIMessages.ArgumentsSection_variableButtonTitle, SWT.NONE);
		variables.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		variables.addSelectionListener(new SelectionAdapter() {
			public void widgetSelected(SelectionEvent e) {
				StringVariableSelectionDialog dialog = new StringVariableSelectionDialog(getSection().getShell());
		...
		vmTab.setText(MDEUIMessages.ArgumentsSection_vmTabLabel);
