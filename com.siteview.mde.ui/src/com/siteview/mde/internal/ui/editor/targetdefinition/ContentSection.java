...
import com.siteview.mde.internal.ui.shared.target.TargetContentsGroup;
...
public class ContentSection extends SectionPart {
	...
	protected void createClient(Section section, FormToolkit toolkit) {
		...
		section.setText(MDEUIMessages.ContentSection_0);

		section.setDescription(MDEUIMessages.ContentSection_1);
