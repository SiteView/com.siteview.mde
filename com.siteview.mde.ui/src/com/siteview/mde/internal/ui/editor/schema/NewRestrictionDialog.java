...
public class NewRestrictionDialog extends MessageDialog {
	...
	public NewRestrictionDialog(Shell parent) {
		super(parent, MDEUIMessages.NewRestrictionDialog_title, null, MDEUIMessages.NewRestrictionDialog_message, QUESTION, new String[] {IDialogConstants.OK_LABEL, IDialogConstants.CANCEL_LABEL}, 0);
	}
