...
public class EnvironmentPage extends FormPage {
	...
	public EnvironmentPage(FormEditor editor) {
		super(editor, PAGE_ID, MDEUIMessages.EnvironmentPage_title);
	}
	...
	protected void createFormContent(IManagedForm managedForm) {
		...
		form.setText(MDEUIMessages.EnvironmentPage_title);
		MDEPlugin.getDefault().getLabelProvider().connect(this);
		form.setImage(MDEPlugin.getDefault().getLabelProvider().get(MDEPluginImages.DESC_TARGET_ENVIRONMENT));
