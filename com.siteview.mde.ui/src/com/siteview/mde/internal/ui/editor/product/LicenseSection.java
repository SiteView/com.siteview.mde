...
public class LicenseSection extends MDESection {

	private FormEntry fURLEntry;
	private FormEntry fLicenseEntry;

	public LicenseSection(MDEFormPage page, Composite parent) {
	...
	protected void createClient(Section section, FormToolkit toolkit) {
		...
		section.setText(MDEUIMessages.LicenseSection_title);
		section.setDescription(MDEUIMessages.LicenseSection_description);
		...
		fURLEntry = new FormEntry(client, toolkit, MDEUIMessages.LicenseSection_url, SWT.NONE);
		...
		fLicenseEntry = new FormEntry(client, toolkit, MDEUIMessages.LicenseSection_text, SWT.MULTI | SWT.WRAP | SWT.V_SCROLL);
