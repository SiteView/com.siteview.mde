...
import com.siteview.mde.internal.ui.editor.IModelUndoManager;
...
public abstract class InputContextManager implements IResourceChangeListener {
	 ...
	 *  
	 */
	public InputContextManager(MDEFormEditor editor) {
		this.editor = editor;
		inputContexts = new Hashtable();
		listeners = new ArrayList();
		MDEPlugin.getWorkspace().addResourceChangeListener(this, IResourceChangeEvent.POST_CHANGE);
	}
	...
	private void updateInputContext(IEditorInput newInput, IEditorInput oldInput) throws Exception {
		...
		if (inputContexts.containsKey(oldInput)) {
			...
			throw new Exception(MDEUIMessages.InputContextManager_errorMessageInputContextNotFound);
		}
