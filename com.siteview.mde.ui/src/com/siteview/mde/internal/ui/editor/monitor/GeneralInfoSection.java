...
/**
 * Provides the first section of the monitor editor describing the bundle id/name/version/etc.
 */
public abstract class GeneralInfoSection extends MDESection {
	...
	protected void createClient(Section section, FormToolkit toolkit) {
		section.setText(MDEUIMessages.MonitorEditor_MonitorSpecSection_desc);
	...
	public void refresh() {
		...
		IMonitorBase monitorBase = model.getMonitorBase();
		fIdEntry.setValue(monitorBase.getId(), true);
		fNameEntry.setValue(monitorBase.getName(), true);
		fVersionEntry.setValue(monitorBase.getVersion(), true);
		fProviderEntry.setValue(monitorBase.getProviderName(), true);
		if (fPlatformFilterEntry != null) {
