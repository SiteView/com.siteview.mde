...
public class SchemaElementReferenceDetails extends AbstractSchemaDetails {
	...
	public void createDetails(Composite parent) {
		...
		fRefLabel = toolkit.createLabel(parent, MDEUIMessages.SchemaElementReferenceDetails_reference);
		...
		setText(MDEUIMessages.SchemaElementReferenceDetails_title);
	}
	...
	public void updateFields(ISchemaObject object) {
		...
		setDecription(NLS.bind(MDEUIMessages.SchemaElementReferenceDetails_description, fElement.getName()));
