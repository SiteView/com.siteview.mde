...
public class BuildPage extends MDEFormPage {
	...
	public BuildPage(FormEditor editor) {
		super(editor, PAGE_ID, MDEUIMessages.BuildPage_name);
	}
	...
	protected void createFormContent(IManagedForm mform) {
		...
		form.setImage(MDEPlugin.getDefault().getLabelProvider().get(MDEPluginImages.DESC_BUILD_EXEC));
		form.setText(MDEUIMessages.BuildEditor_BuildPage_title);
	...
	private String getCustomText() {
		return MDEUIMessages.BuildPage_custom;
	}
