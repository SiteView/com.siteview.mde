...
public class FeaturesPage extends MDEFormPage {
	...
	public FeaturesPage(MDEFormEditor editor) {
		super(editor, PAGE_ID, MDEUIMessages.FeaturesPage_title);
	...
	protected void createFormContent(IManagedForm managedForm) {
		...
		form.setText(MDEUIMessages.FeaturesPage_header);
		form.setImage(MDEPlugin.getDefault().getLabelProvider().get(MDEPluginImages.DESC_SITE_XML_OBJ));
