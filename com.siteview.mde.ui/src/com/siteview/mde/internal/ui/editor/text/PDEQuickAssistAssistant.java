...
import com.siteview.mde.internal.ui.correction.AbstractPDEMarkerResolution;
import com.siteview.mde.internal.ui.correction.ResolutionGenerator;
...
public class PDEQuickAssistAssistant extends QuickAssistAssistant {
	...
	public PDEQuickAssistAssistant() {
		...
		fCreateImage = MDEPluginImages.DESC_ADD_ATT.createImage();
		fRemoveImage = MDEPluginImages.DESC_DELETE.createImage();
		fRenameImage = MDEPluginImages.DESC_REFRESH.createImage();
