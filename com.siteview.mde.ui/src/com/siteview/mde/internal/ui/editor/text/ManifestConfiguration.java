...
import com.siteview.mde.internal.ui.editor.contentassist.ManifestContentAssistProcessor;
...
public class ManifestConfiguration extends ChangeAwareSourceViewerConfiguration {
	...
	public ManifestConfiguration(IColorManager manager, MDESourcePage page) {
		this(manager, page, null);
	}

	public ManifestConfiguration(IColorManager manager, MDESourcePage page, String documentPartitioning) {
		super(page, manager);
