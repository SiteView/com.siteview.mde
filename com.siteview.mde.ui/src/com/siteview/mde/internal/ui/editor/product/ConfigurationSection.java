...
import com.siteview.mde.internal.ui.util.FileNameFilter;
...
public class ConfigurationSection extends MDESection {
	...
	public ConfigurationSection(MDEFormPage page, Composite parent) {
	...
	protected void createClient(Section section, FormToolkit toolkit) {
		...
		section.setText(MDEUIMessages.ConfigurationSection_title);
		section.setDescription(MDEUIMessages.ConfigurationSection_desc);
		...
		fDefault = toolkit.createButton(client, MDEUIMessages.ConfigurationSection_default, SWT.RADIO);
		gd = new GridData();
		gd.horizontalSpan = 3;
		...
		fCustom = toolkit.createButton(client, MDEUIMessages.ConfigurationSection_existing, SWT.RADIO);
		gd = new GridData();
		gd.horizontalSpan = 3;
		...
		fCustomEntry = new FormEntry(client, toolkit, MDEUIMessages.ConfigurationSection_file, MDEUIMessages.ConfigurationSection_browse, isEditable(), 35); // 
	...
	private void handleBrowse() {
		...
		dialog.setTitle(MDEUIMessages.ConfigurationSection_selection);
		dialog.setMessage(MDEUIMessages.ConfigurationSection_message);
