...
public abstract class TableSection extends StructuredViewerSection {
	...
	class PartAdapter extends EditableTablePart {
		...
		protected void updateLabel() {
			if (fCount != null && !fCount.isDisposed())
				fCount.setText(NLS.bind(MDEUIMessages.TableSection_itemCount, Integer.toString(getTableViewer().getTable().getItemCount())));
		}
	}
	 ...
	 * @param formPage
	 */
	public TableSection(MDEFormPage formPage, Composite parent, int style, String[] buttonLabels) {
	 ...
	 * @param formPage
	 */
	public TableSection(MDEFormPage formPage, Composite parent, int style, boolean titleBar, String[] buttonLabels) {
