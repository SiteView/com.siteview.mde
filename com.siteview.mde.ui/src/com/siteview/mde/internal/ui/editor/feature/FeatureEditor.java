...
public class FeatureEditor extends MultiSourceEditor implements IShowEditorInput {
	...
	protected String getEditorID() {
		return IMDEUIConstants.FEATURE_EDITOR_ID;
	}
	...
	public static void openFeatureEditor(IFeatureModel model) {
		if (model != null) {
			...
			try {
				...
				IDE.openEditor(MDEPlugin.getActivePage(), input, IMDEUIConstants.FEATURE_EDITOR_ID, true);
	...
	protected void addEditorPages() {
		try {
			addPage(new FeatureFormPage(this, MDEUIMessages.FeatureEditor_FeaturePage_title));
			...
			addPage(new FeatureIncludesPage(this, MDEUIMessages.FeatureEditor_IncludesPage_title));
			addPage(new FeatureDependenciesPage(this, MDEUIMessages.FeatureEditor_DependenciesPage_title));
			addPage(new FeatureAdvancedPage(this, MDEUIMessages.FeatureEditor_AdvancedPage_title));
			if (fInputContextManager.hasContext(BuildInputContext.CONTEXT_ID))
	...
	protected Action getFeatureExportAction() {
		if (fExportAction == null) {
			...
			fExportAction.setToolTipText(MDEUIMessages.FeatureEditor_exportTooltip);
			fExportAction.setImageDescriptor(MDEPluginImages.DESC_EXPORT_FEATURE_TOOL);
		}
