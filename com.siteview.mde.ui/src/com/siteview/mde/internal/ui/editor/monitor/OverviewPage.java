...
public class OverviewPage extends LaunchShortcutOverviewPage {
	...
	protected void createFormContent(IManagedForm managedForm) {
		...
		form.setText(MDEUIMessages.ManifestEditor_OverviewPage_title);
	...
	private void createContentSection(IManagedForm managedForm, Composite parent, FormToolkit toolkit) {
		String sectionTitle;
		if (isFragment()) {
			sectionTitle = MDEUIMessages.ManifestEditor_ContentSection_ftitle;
		} else {
			sectionTitle = MDEUIMessages.ManifestEditor_ContentSection_title;
		}
