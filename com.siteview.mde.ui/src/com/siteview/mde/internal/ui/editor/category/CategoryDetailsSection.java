...
public class CategoryDetailsSection extends MDESection implements IFormPart, IPartSelectionListener {
	...
	public CategoryDetailsSection(MDEFormPage page, Composite parent) {
		this(page, parent, MDEUIMessages.CategoryDetails_title, MDEUIMessages.CategoryDetails_sectionDescription, SWT.NULL);

	}

	public CategoryDetailsSection(MDEFormPage page, Composite parent, String title, String desc, int toggleStyle) {
	...
	public void createClient(Section section, FormToolkit toolkit) {
			...
			public void textValueChanged(FormEntry text) {
				try {
					if (text.getValue().length() <= 0 || alreadyExists(text.getValue())) {
						...
						MessageDialog.openError(MDEPlugin.getActiveWorkbenchShell(), MDEUIMessages.CategoryDetails_alreadyExists_title, message);
					} else {
		...
		fLabelText = new FormEntry(container, toolkit, MDEUIMessages.CategoryDetails_label, null, false);
		...
		fDescriptionText = new FormEntry(container, toolkit, MDEUIMessages.CategoryDetails_desc, SWT.WRAP | SWT.MULTI);
