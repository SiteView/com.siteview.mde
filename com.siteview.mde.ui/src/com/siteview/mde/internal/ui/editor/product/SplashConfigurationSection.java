...
import com.siteview.mde.internal.ui.wizards.product.ISplashHandlerConstants;
...
public class SplashConfigurationSection extends MDESection {
	...
	public SplashConfigurationSection(MDEFormPage page, Composite parent) {
	...
	private void createUIFieldDecorationTemplate() {
		...
		fControlDecoration.setDescriptionText(MDEUIMessages.SplashConfigurationSection_msgDecorationTemplateSupport);
	...
	private void createUILabelType(Composite parent) {
		...
		Label label = fToolkit.createLabel(parent, MDEUIMessages.SplashTemplatesSection_typeName, SWT.WRAP);
	...
	private void createUILabelProgress(Composite parent) {
		Label label = fToolkit.createLabel(parent, MDEUIMessages.SplashConfigurationSection_sectionDescCustomization, SWT.WRAP);
	...
	private void createUIFieldTemplateCombo(Composite parent) {
		...
		// Add "none" element
		fFieldTemplateCombo.add(MDEUIMessages.SplashConfigurationSection_none, 0);
	...
	private void configureUISection() {
		...
		fSection.setText(MDEUIMessages.SplashProgressSection_progressName);
		fSection.setDescription(MDEUIMessages.SplashProgressSection_progressSectionDesc);
	}

	private void createProgressBarConfig(Composite parent) {
		fAddBarButton = createButton(parent, fToolkit, MDEUIMessages.SplashSection_progressBar);
		...
		fBarControls[0] = createLabel(parent, fToolkit, foreground, MDEUIMessages.SplashSection_progressX);
		fBarControls[1] = fBarSpinners[0] = createSpinner(parent, fToolkit);
		fBarControls[2] = createLabel(parent, fToolkit, foreground, MDEUIMessages.SplashSection_progressY);
		fBarControls[3] = fBarSpinners[1] = createSpinner(parent, fToolkit);
		fBarControls[4] = createLabel(parent, fToolkit, foreground, MDEUIMessages.SplashSection_progressWidth);
		fBarControls[5] = fBarSpinners[2] = createSpinner(parent, fToolkit);
		fBarControls[6] = createLabel(parent, fToolkit, foreground, MDEUIMessages.SplashSection_progressHeight);
	...
	private void createProgressMessageConfig(Composite parent) {
		fAddMessageButton = createButton(parent, fToolkit, MDEUIMessages.SplashSection_progressMessage);
		...
		fMessageControls[0] = createLabel(parent, fToolkit, foreground, MDEUIMessages.SplashSection_messageX);
		fMessageControls[1] = fMessageSpinners[0] = createSpinner(parent, fToolkit);
		fMessageControls[2] = createLabel(parent, fToolkit, foreground, MDEUIMessages.SplashSection_messageY);
		fMessageControls[3] = fMessageSpinners[1] = createSpinner(parent, fToolkit);

		fMessageControls[4] = createLabel(parent, fToolkit, foreground, MDEUIMessages.SplashSection_messageWidth);
		fMessageControls[5] = fMessageSpinners[2] = createSpinner(parent, fToolkit);
		fMessageControls[6] = createLabel(parent, fToolkit, foreground, MDEUIMessages.SplashSection_messageHeight);
		fMessageControls[7] = fMessageSpinners[3] = createSpinner(parent, fToolkit);

		fMessageControls[8] = createLabel(parent, fToolkit, foreground, MDEUIMessages.SplashSection_messageColor);
	...
	private void updateUIFieldTemplateCombo() {
		...
		if (info.isDefinedSplashHandlerType() == false) {
			...
			fFieldTemplateCombo.setText(MDEUIMessages.SplashConfigurationSection_none);
			return;
		}
	...
	private void addOffsetTooltips(Control[] controls) {
		...
		for (int i = 0; i < limit; i++) {
			controls[i].setToolTipText(MDEUIMessages.SplashConfigurationSection_msgTooltipOffsetRelative);
		}
	}
