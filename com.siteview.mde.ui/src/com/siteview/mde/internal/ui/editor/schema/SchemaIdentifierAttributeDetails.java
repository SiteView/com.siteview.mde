...
public class SchemaIdentifierAttributeDetails extends SchemaAttributeDetails {
	...
	protected void createTypeDetails(Composite parent, FormToolkit toolkit) {
		...
		fReferenceEntry = new FormEntry(parent, toolkit, MDEUIMessages.SchemaStringAttributeDetails_reference, MDEUIMessages.SchemaAttributeDetails_browseButton, false, 11);

		Color foreground = toolkit.getColors().getColor(IFormColors.TITLE);
		Label label = toolkit.createLabel(parent, MDEUIMessages.SchemaIdentifierAttributeDetails_additionalRestrictions);
		...
		fAddRestriction = toolkit.createButton(resButtonComp, MDEUIMessages.SchemaAttributeDetails_addRestButton, SWT.NONE);
		fRemoveRestriction = toolkit.createButton(resButtonComp, MDEUIMessages.SchemaAttributeDetails_removeRestButton, SWT.NONE);
	...
	private void doOpenSelectionDialog(FormEntry entry) {
		FilteredSchemaAttributeSelectionDialog dialog = new FilteredSchemaAttributeSelectionDialog(MDEPlugin.getActiveWorkbenchShell());
