...
import com.siteview.mde.internal.ui.editor.monitor.MatchSection;
 ...
 * 
 */
public class FeatureDependenciesPage extends MDEFormPage {
	 ...
	 * @param title
	 */
	public FeatureDependenciesPage(MDEFormEditor editor, String title) {
	...
	public void initialize() {
		getManagedForm().getForm().setText(MDEUIMessages.FeatureEditor_DependenciesPage_heading);
	}
}
