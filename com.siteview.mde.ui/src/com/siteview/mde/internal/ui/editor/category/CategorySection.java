...
public class CategorySection extends TreeSection implements IFeatureModelListener {
	...
	public CategorySection(MDEFormPage formPage, Composite parent) {
		super(formPage, parent, Section.DESCRIPTION, new String[] {MDEUIMessages.CategoryDefinitionCategorySection_new, MDEUIMessages.CategorySection_add});
		getSection().setText(MDEUIMessages.CategoryDefinitionCategorySection_title);
		getSection().setDescription(MDEUIMessages.CategoryDefinitionCategorySection_desc);
	}
	...
	private void handleAddCategoryDefinition() {
		String name = NLS.bind(MDEUIMessages.CategorySection_newCategoryName, Integer.toString(++fCounter));
		while (categoryExists(name)) {
			name = NLS.bind(MDEUIMessages.CategorySection_newCategoryName, Integer.toString(++fCounter));
		}
		String label = NLS.bind(MDEUIMessages.CategorySection_newCategoryLabel, Integer.toString(fCounter));
