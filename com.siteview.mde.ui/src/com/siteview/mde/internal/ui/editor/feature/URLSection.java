...
import com.siteview.mde.internal.core.feature.FeatureURLElement;
...
public class URLSection extends TableSection {
	...
	public URLSection(MDEFormPage page, Composite parent) {
		super(page, parent, Section.DESCRIPTION | ExpandableComposite.NO_TITLE, false, new String[] {MDEUIMessages.FeatureEditor_URLSection_new});
		MDELabelProvider provider = MDEPlugin.getDefault().getLabelProvider();
		fUrlImage = provider.get(MDEPluginImages.DESC_LINK_OBJ);
		createClient(getSection(), page.getManagedForm().getToolkit());

		getSection().setDescription(MDEUIMessages.FeatureEditor_URLSection_desc);
	}
	...
	private void handleNew() {
		...
		try {
			...
			element.setLabel(MDEUIMessages.FeatureEditor_URLSection_newDiscoverySite);
			element.setURL(new URL(MDEUIMessages.FeatureEditor_URLSection_newURL));
