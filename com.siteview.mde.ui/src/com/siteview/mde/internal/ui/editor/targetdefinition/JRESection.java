...
public class JRESection extends SectionPart {
	...
	protected void createClient(Section section, FormToolkit toolkit) {
		section.setText(MDEUIMessages.EnvironmentBlock_jreTitle);
		section.setDescription(MDEUIMessages.JRESection_description);
		...
		fDefaultJREButton = toolkit.createButton(client, MDEUIMessages.JRESection_defaultJRE, SWT.RADIO);
		...
		fNamedJREButton = toolkit.createButton(client, MDEUIMessages.JRESection_JREName, SWT.RADIO);
		...
		fConfigureJREButton = toolkit.createButton(client, MDEUIMessages.JRESection_jrePreference, SWT.PUSH);
		...
		fExecEnvButton = toolkit.createButton(client, MDEUIMessages.JRESection_ExecutionEnv, SWT.RADIO);
		...
		Button configureEEButton = toolkit.createButton(client, MDEUIMessages.JRESection_eePreference, SWT.PUSH);
