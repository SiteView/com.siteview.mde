 ...
 */
public class MDEPluginImages {

	private static final String NAME_PREFIX = MDEPlugin.getPluginId() + "."; //$NON-NLS-1$
	...
	private static URL makeImageURL(String prefix, String name) {
		...
		return FileLocator.find(MDEPlugin.getDefault().getBundle(), new Path(path), null);
	}
