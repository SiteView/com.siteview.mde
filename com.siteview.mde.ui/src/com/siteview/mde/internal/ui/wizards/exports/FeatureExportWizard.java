...
public class FeatureExportWizard extends AntGeneratingExportWizard {
	...
	public FeatureExportWizard() {
		setDefaultPageImageDescriptor(MDEPluginImages.DESC_FEATURE_EXPORT_WIZ);
	}
	...
	protected void scheduleExportJob() {
		...
		final FeatureExportOperation job = new FeatureExportOperation(info, MDEUIMessages.FeatureExportJob_name);
		job.setUser(true);
