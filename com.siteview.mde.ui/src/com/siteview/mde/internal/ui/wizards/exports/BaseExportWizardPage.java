...
public abstract class BaseExportWizardPage extends AbstractExportWizardPage {
	...
	public BaseExportWizardPage(IStructuredSelection selection, String name, String choiceLabel) {
		...
		fExportPart = new ExportPart(choiceLabel, new String[] {MDEUIMessages.WizardCheckboxTablePart_selectAll, MDEUIMessages.WizardCheckboxTablePart_deselectAll, MDEUIMessages.ExportWizard_workingSet});
