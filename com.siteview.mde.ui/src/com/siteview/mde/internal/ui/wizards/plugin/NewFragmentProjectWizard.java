...
public class NewFragmentProjectWizard extends NewWizard implements IExecutableExtension {
	...
	public NewFragmentProjectWizard() {
		setDefaultPageImageDescriptor(MDEPluginImages.DESC_NEWFRAGPRJ_WIZ);
		setDialogSettings(MDEPlugin.getDefault().getDialogSettings());
		setWindowTitle(MDEUIMessages.NewFragmentProjectWizard_title);
	...
	public void addPages() {
		...
		fMainPage.setTitle(MDEUIMessages.NewProjectWizard_MainPage_ftitle);
		fMainPage.setDescription(MDEUIMessages.NewProjectWizard_MainPage_fdesc);
		addPage(fMainPage);
