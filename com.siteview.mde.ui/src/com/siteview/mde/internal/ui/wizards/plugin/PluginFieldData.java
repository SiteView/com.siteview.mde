...
import com.siteview.mde.ui.IPluginFieldData;
...
public class PluginFieldData extends AbstractFieldData implements IPluginFieldData {
	...
	/* (non-Javadoc)
	 * @see com.siteview.mde.ui.IPluginFieldData#getClassname()
	 */
	...
	/* (non-Javadoc)
	 * @see com.siteview.mde.ui.IPluginFieldData#isUIPlugin()
	 */
	...
	/* (non-Javadoc)
	 * @see com.siteview.mde.ui.IPluginFieldData#doGenerateClass()
	 */
