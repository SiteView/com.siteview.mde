...
public class NewSiteProjectWizard extends NewWizard implements IExecutableExtension {
	...
	public NewSiteProjectWizard() {
		setDefaultPageImageDescriptor(MDEPluginImages.DESC_NEWSITEPRJ_WIZ);
		setDialogSettings(MDEPlugin.getDefault().getDialogSettings());
		setNeedsProgressMonitor(true);
		setWindowTitle(MDEUIMessages.NewSiteWizard_wtitle);
	}

	public void addPages() {
		fMainPage = new NewSiteProjectCreationPage("main"); //$NON-NLS-1$
		fMainPage.setTitle(MDEUIMessages.NewSiteWizard_MainPage_title);
		fMainPage.setDescription(MDEUIMessages.NewSiteWizard_MainPage_desc);
