...
public interface ISplashHandlerConstants {
	...
	public final static String[][] F_SPLASH_SCREEN_TYPE_CHOICES = { {"interactive", MDEUIMessages.UpdateSplashHandlerInModelAction_templateTypeInteractive}, //$NON-NLS-1$
			{"browser", MDEUIMessages.UpdateSplashHandlerInModelAction_templateTypeBrowser}, //$NON-NLS-1$
			{"extensible", MDEUIMessages.UpdateSplashHandlerInModelAction_templateTypeExtensible} //$NON-NLS-1$
	};
