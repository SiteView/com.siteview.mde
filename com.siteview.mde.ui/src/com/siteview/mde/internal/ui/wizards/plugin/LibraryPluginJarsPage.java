...
public class LibraryPluginJarsPage extends WizardPage {
	...
	public LibraryPluginJarsPage(String pageName, LibraryPluginFieldData data, Collection jarPaths) {
		super(pageName);
		fData = data;
		setTitle(MDEUIMessages.LibraryPluginJarsPage_title);
		setDescription(MDEUIMessages.LibraryPluginJarsPage_desc);
		if (jarPaths != null)
	...
	private void chooseWorkspaceFile() {
		...
		dialog.setTitle(MDEUIMessages.LibraryPluginJarsPage_SelectionDialog_title);
		dialog.setMessage(MDEUIMessages.LibraryPluginJarsPage_SelectionDialog_message);
