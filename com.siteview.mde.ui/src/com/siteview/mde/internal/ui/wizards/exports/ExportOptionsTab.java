...
public class ExportOptionsTab extends AbstractExportTab {
	...
	protected void addSourceOption(Composite container) {
		...
		fIncludeSourceButton.setText(MDEUIMessages.ExportWizard_includeSource);
	...
	protected void addUseWorkspaceCompiledClassesSection(Composite comp) {
		...
		fUseWSCompiledClasses.setText(MDEUIMessages.ExportOptionsTab_use_workspace_classfiles);
	}

	protected String getJarButtonText() {
		return MDEUIMessages.BaseExportWizardPage_packageJARs;
	}
	...
	protected void addAntSection(Composite container) {
		...
		fSaveAsAntButton.setText(MDEUIMessages.ExportWizard_antCheck);
		GridData gd = new GridData();
		gd.horizontalSpan = 1;
		...
		fBrowseAnt.setText(MDEUIMessages.ExportWizard_browse);
	...
	protected void addQualifierOption(Composite container) {
		...
		fQualifierButton.setText(MDEUIMessages.AdvancedPluginExportPage_qualifier);
	...
	protected void initialize(IDialogSettings settings) {
		...
		fIncludeSourceCombo.setItems(new String[] {MDEUIMessages.ExportWizard_generateAssociatedSourceBundles, MDEUIMessages.ExportWizard_includeSourceInBinaryBundles});
	...
	protected String validate() {
		if (fSaveAsAntButton.getSelection() && fAntCombo.getText().trim().length() == 0)
			return MDEUIMessages.ExportWizard_status_noantfile;
		return null;
	}
	...
	protected String validateAntCombo() {
		...
		if ("build.xml".equals(path)) //$NON-NLS-1$
			return MDEUIMessages.ExportOptionsTab_antReservedMessage;
		return null;
	}
	...
	protected boolean doExportSourceBundles() {
		return MDEUIMessages.ExportWizard_generateAssociatedSourceBundles.equals(fIncludeSourceCombo.getText());
	}
