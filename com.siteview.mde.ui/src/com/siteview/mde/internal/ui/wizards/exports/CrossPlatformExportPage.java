...
public class CrossPlatformExportPage extends AbstractExportWizardPage {
	...
	public CrossPlatformExportPage(String pageName, IFeatureModel model) {
		super(pageName);
		fPlatformPart = new PlatformPart(MDEUIMessages.CrossPlatformExportPage_available, new String[] {MDEUIMessages.WizardCheckboxTablePart_selectAll, MDEUIMessages.WizardCheckboxTablePart_deselectAll});
		setTitle(MDEUIMessages.CrossPlatformExportPage_title);
		setDescription(MDEUIMessages.CrossPlatformExportPage_desc);
		fModel = model;
	}
