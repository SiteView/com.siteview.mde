...
public class FeatureOptionsTab extends ExportOptionsTab {
	...
	private class CategoryResourceListSelectionDialog extends FilteredResourcesSelectionDialog {
		...
		protected IStatus validateItem(Object item) {
			...
			return new Status(IStatus.ERROR, IMDEUIConstants.PLUGIN_ID, MDEUIMessages.FeatureOptionsTab_0);
		}
	}
	...
	protected void addAdditionalOptions(Composite comp) {
		...
		fExportMetadata = SWTFactory.createCheckButton(comp, MDEUIMessages.ExportWizard_includesMetadata, null, false, 1);
		...
		fCategoryButton.setText(MDEUIMessages.ExportWizard_generateCategories + ":"); //$NON-NLS-1$
		...
		fCategoryBrowse.setText(MDEUIMessages.ExportWizard_browse);
	...
	protected String getJarButtonText() {
		return MDEUIMessages.BaseExportWizardPage_fPackageJARs;
	}
	...
	protected void openFile(Combo combo) {
		CategoryResourceListSelectionDialog dialog = new CategoryResourceListSelectionDialog(fPage.getShell(), false, MDEPlugin.getWorkspace().getRoot(), IResource.FILE);
