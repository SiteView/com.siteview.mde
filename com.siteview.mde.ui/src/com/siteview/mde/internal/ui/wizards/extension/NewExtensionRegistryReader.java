...
public class NewExtensionRegistryReader {
	...
	private final static String UNCATEGORIZED_WIZARD_CATEGORY = "com.siteview.mde.ui.Other"; //$NON-NLS-1$
	...
	private void processCategory(IConfigurationElement config, ElementList list) {
		...
		if (category.getID() == null || category.getLabel() == null) {
			System.out.println(MDEUIMessages.NewExtensionRegistryReader_missingProperty);
			return;
		}
