...
public class FeatureSpecPage extends AbstractFeatureSpecPage {
	...
	public FeatureSpecPage() {
		super();
		setTitle(MDEUIMessages.NewFeatureWizard_SpecPage_title);
	...
	protected void initialize() {
		...
		setMessage(MDEUIMessages.NewFeatureWizard_MainPage_desc);
	}
	...
	protected void createContents(Composite container) {
		...
		group.setText(MDEUIMessages.BaseFeatureSpecPage_featurePropertiesGroup_title);
		...
		label.setText(MDEUIMessages.NewFeatureWizard_SpecPage_provider);
