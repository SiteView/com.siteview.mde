...
public class MonitorSearchActionGroup extends ActionGroup {
	...
	private void addOpenSchemaAction(Object object, IMenuManager menu) {
		if (object instanceof IMonitorExtension) {
			...
			menu.add(action);
		} else if (object instanceof IMonitorExtensionPoint) {
			// From PluginSearchResultPage
			// From ExtensionPointsSection
			OpenSchemaAction action = new OpenSchemaAction();
			IMonitorExtensionPoint point = (IMonitorExtensionPoint) object;
	...
	private void addShowDescriptionAction(Object object, IMenuManager menu) {
		if (object instanceof IMonitorExtensionPoint) {
			IMonitorExtensionPoint extPoint = (IMonitorExtensionPoint) object;
			...
			IMonitorExtensionPoint extPoint = MDECore.getDefault().getExtensionsRegistry().findExtensionPoint(point);
			if (extPoint != null)
