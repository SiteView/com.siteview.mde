...
import com.siteview.mde.internal.core.text.bundle.ExportPackageHeader;
...
public class CalculateUsesOperation extends WorkspaceModifyOperation {
	...
	protected Map findPackageReferences(Collection packages, IProgressMonitor monitor) {
		...
		for (int i = 0; i < frags.length; i++) {
			...
			monitor.subTask(NLS.bind(MDEUIMessages.CalculateUsesOperation_calculatingDirective, frags[i].getElementName()));
