...
public class PluginSearchPage extends DialogPage implements ISearchPage {
	...
	private void createPatternSection(Composite parent) {
		...
		label.setText(MDEUIMessages.SearchPage_searchString);
		...
		caseSensitive.setText(MDEUIMessages.SearchPage_caseSensitive);
	}
	...
	private void createSettingsSection(Composite parent) {
		...
		createGroup(result, searchForButtons, MDEUIMessages.SearchPage_searchFor, new String[] {MDEUIMessages.SearchPage_plugin, MDEUIMessages.SearchPage_fragment, MDEUIMessages.SearchPage_extPt}, 2);
		createGroup(result, limitToButtons, MDEUIMessages.SearchPage_limitTo, new String[] {MDEUIMessages.SearchPage_declarations, MDEUIMessages.SearchPage_references, MDEUIMessages.SearchPage_allOccurrences}, 1);
		createGroup(result, externalScopeButtons, MDEUIMessages.SearchPage_externalScope, new String[] {MDEUIMessages.SearchPage_all, MDEUIMessages.SearchPage_enabledOnly, MDEUIMessages.SearchPage_none}, 1);
	}
