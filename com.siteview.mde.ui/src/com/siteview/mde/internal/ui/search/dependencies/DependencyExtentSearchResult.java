...
public class DependencyExtentSearchResult extends SearchResult implements IEditorMatchAdapter {
	...
	public String getLabel() {
		...
		return fQuery.getLabel() + " - " + count + " " + (count == 1 ? MDEUIMessages.DependencyExtentSearchResult_dependency : MDEUIMessages.DependencyExtentSearchResult_dependencies); //$NON-NLS-1$ //$NON-NLS-2$  
	}
