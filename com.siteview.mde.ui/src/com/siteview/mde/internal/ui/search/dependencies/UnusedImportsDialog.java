...
import com.siteview.mde.internal.ui.wizards.ListUtil.PluginComparator;
...
public class UnusedImportsDialog extends TrayDialog {
	...
	public UnusedImportsDialog(Shell parentShell, IMonitorModelBase model, Object[] unused) {
		super(parentShell);
		setShellStyle(getShellStyle() | SWT.RESIZE);
		this.model = model;
		this.unused = unused;
		checkboxTablePart = new WizardCheckboxTablePart(MDEUIMessages.UnusedDependencies_remove);
	}
	...
	protected Control createDialogArea(Composite parent) {
		...
		choiceViewer.setLabelProvider(MDEPlugin.getDefault().getLabelProvider());
		...
		choiceViewer.setInput(MDEPlugin.getDefault());
