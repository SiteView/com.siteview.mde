...
import com.siteview.mde.internal.ui.parts.StatusInfo;
...
public class HistoryListDialog extends StatusDialog {
	...
	public HistoryListDialog(Shell shell, String[] elements) {
		super(shell);
		setTitle(MDEUIMessages.HistoryListDialog_title);
	...
	protected Control createDialogArea(Composite parent) {
		...
		label.setText(MDEUIMessages.HistoryListDialog_label);
	...
	private void createListButtons(Composite parent) {
		...
		fRemoveButton.setText(MDEUIMessages.HistoryListDialog_remove_button);
	...
	private Control createTableArea(Composite parent) {
		...
		fHistoryViewer.setInput(MDECore.getDefault().getModelManager());
