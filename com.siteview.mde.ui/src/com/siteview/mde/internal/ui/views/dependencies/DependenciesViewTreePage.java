...
public class DependenciesViewTreePage extends DependenciesViewPage {
	class CollapseAllAction extends Action {
		public CollapseAllAction() {
			super();
			setText(MDEUIMessages.DependenciesViewTreePage_CollapseAllAction_label);
			setDescription(MDEUIMessages.DependenciesViewTreePage_CollapseAllAction_description);
			setToolTipText(MDEUIMessages.DependenciesViewTreePage_CollapseAllAction_tooltip);
			setImageDescriptor(MDEPluginImages.DESC_COLLAPSE_ALL);
			setDisabledImageDescriptor(MDEPluginImages.DESC_COLLAPSE_ALL);
		}
