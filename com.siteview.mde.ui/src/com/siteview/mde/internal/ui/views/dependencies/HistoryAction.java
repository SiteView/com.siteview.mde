...
public class HistoryAction extends Action {
	...
	public HistoryAction(DependenciesView view, String element) {
		...
		setDisabledImageDescriptor(MDEPluginImages.DESC_PLUGIN_OBJ);

		setDescription(NLS.bind(MDEUIMessages.HistoryAction_description, elementName));
		setToolTipText(NLS.bind(MDEUIMessages.HistoryAction_tooltip, elementName));
