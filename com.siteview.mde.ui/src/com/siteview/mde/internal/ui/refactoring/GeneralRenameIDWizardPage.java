...
public abstract class GeneralRenameIDWizardPage extends UserInputWizardPage {
	...
	protected void createNewID(Composite composite) {
		...
		label.setText(MDEUIMessages.RenamePluginWizardPage_newId);
	...
	protected void createUpdateReferences(Composite composite) {
		...
		fUpdateReferences.setText(MDEUIMessages.RenamePluginWizardPage_updateReferences);
	...
	protected void validatePage() {
		...
		if (text.length() == 0)
			errorMessage = MDEUIMessages.RenamePluginWizardPage_idNotSet;
		else
