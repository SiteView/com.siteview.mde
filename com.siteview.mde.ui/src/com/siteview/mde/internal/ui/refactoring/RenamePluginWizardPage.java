...
public class RenamePluginWizardPage extends GeneralRenameIDWizardPage {
	...
	private void createRenameProject(Composite composite) {
		...
		fRenameProject.setText(MDEUIMessages.RenamePluginWizardPage_renameProject);
	...
	protected String validateId(String id) {
		return IdUtil.isValidCompositeID3_0(id) ? null : MDEUIMessages.RenamePluginWizardPage_invalidId;
	}
