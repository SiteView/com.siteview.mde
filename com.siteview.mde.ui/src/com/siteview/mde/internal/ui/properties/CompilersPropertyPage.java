...
import com.siteview.mde.internal.ui.preferences.CompilersPreferencePage;
import com.siteview.mde.internal.ui.preferences.PDECompilersConfigurationBlock;
...
public class CompilersPropertyPage extends PropertyPage {
	...
	protected Control createContents(Composite parent) {
		...
		fProjectSpecific.setText(MDEUIMessages.CompilersPropertyPage_useprojectsettings_label);
		...
		if (offerLink()) {
			...
			fWorkspaceLink.setText(MDEUIMessages.CompilersPropertyPage_useworkspacesettings_change);
			fWorkspaceLink.addSelectionListener(new SelectionAdapter() {
				public void widgetSelected(SelectionEvent e) {
					HashMap data = new HashMap();
					data.put(CompilersPreferencePage.NO_LINK, Boolean.TRUE);
					SWTFactory.showPreferencePage(getShell(), "com.siteview.mde.ui.CompilersPreferencePage", data); //$NON-NLS-1$
				}
			});
		}
