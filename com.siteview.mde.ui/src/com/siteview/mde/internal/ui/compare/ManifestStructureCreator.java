...
import com.siteview.mde.internal.ui.editor.text.ManifestPartitionScanner;
...
public class ManifestStructureCreator extends StructureCreator {
	...
	public String getName() {
		return MDEUIMessages.ManifestStructureCreator_name;
	}
	...
	protected IStructureComparator createStructureComparator(Object input, IDocument document, ISharedDocumentAdapter adapter, IProgressMonitor monitor) throws CoreException {
		...
		try {
			...
			throw new CoreException(new Status(IStatus.ERROR, MDEPlugin.getPluginId(), 0, MDEUIMessages.ManifestStructureCreator_errorMessage, ex));
		}
