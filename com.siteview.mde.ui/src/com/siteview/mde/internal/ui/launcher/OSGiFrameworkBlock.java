...
import com.siteview.mde.internal.launching.launcher.OSGiFrameworkManager;
...
public class OSGiFrameworkBlock {
	...
	public void createControl(Composite parent) {
		...
		launchLabel.setText(MDEUIMessages.PluginsTab_launchWith);
		gd = new GridData();
		gd.horizontalIndent = 5;
		launchLabel.setLayoutData(gd);

		fLaunchWithCombo = SWTFactory.createCombo(composite, SWT.READ_ONLY, 1, SWT.NONE, new String[] {MDEUIMessages.OSGiFrameworkBlock_selectedBundles, MDEUIMessages.PluginsTab_customFeatureMode});

		fLaunchWithCombo.addSelectionListener(fListener);

		Label label = new Label(composite, SWT.NONE);
		label.setText(MDEUIMessages.OSGiBundlesTab_frameworkLabel);
		gd = new GridData();
		gd.horizontalIndent = 5;
		...
		gd.horizontalIndent = 5;
		label.setLayoutData(gd);
		label.setText(MDEUIMessages.EquinoxPluginsTab_defaultStart);
		...
		gd.horizontalIndent = 5;
		label.setLayoutData(gd);
		label.setText(MDEUIMessages.EquinoxPluginsTab_defaultAuto);
