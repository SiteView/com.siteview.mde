...
import com.siteview.mde.internal.launching.launcher.VMHelper;
import com.siteview.mde.internal.ui.MDEUIMessages;
import com.siteview.mde.internal.ui.SWTFactory;
...
public class JREBlock {
	...
	public void createControl(Composite parent) {
		...
		group.setText(MDEUIMessages.MainTab_jreSection);
	...
	protected void createJRESection(Composite parent) {
		...
		fEeButton.setText(MDEUIMessages.BasicLauncherTab_ee);
		...
		fEePrefButton.setText(MDEUIMessages.BasicLauncherTab_environments);
		...
		fJreButton.setText(MDEUIMessages.BasicLauncherTab_jre);
		...
		fJrePrefButton.setText(MDEUIMessages.BasicLauncherTab_installedJREs);
	...
	protected void createJavaExecutableSection(Composite parent) {
		...
		label.setText(MDEUIMessages.BasicLauncherTab_javaExec);
		...
		fJavawButton.setText(MDEUIMessages.BasicLauncherTab_javaExecDefault); // 
	...
	private void createBootstrapEntriesSection(Composite parent) {
		Label label = new Label(parent, SWT.NONE);
		label.setText(MDEUIMessages.BasicLauncherTab_bootstrap);
	...
	private void setEECombo() {
		...
		for (int i = 0; i < eeObjects.length; i++) {
			...
			try {
				...
				vm = MDEUIMessages.BasicLauncherTab_unbound;
			}
	...
	public String validate() {
		if (fEeButton.getSelection() && fEeCombo.getText().indexOf(MDEUIMessages.BasicLauncherTab_unbound) != -1)
			return NLS.bind(MDEUIMessages.BasicLauncherTab_noJreForEeMessage, parseEESelection(fEeCombo.getText()));
		return null;
	}
