...
public class ConfigurationTemplateBlock extends BaseBlock {
	...
	public void createControl(Composite parent) {
		...
		group.setText(MDEUIMessages.ConfigurationTab_configFileGroup);
		group.setLayout(new GridLayout(2, false));
		group.setLayoutData(new GridData(GridData.FILL_HORIZONTAL));

		fGenerateFileButton = new Button(group, SWT.RADIO);
		fGenerateFileButton.setText(MDEUIMessages.ConfigurationTab_defaultConfigIni);
		...
		fUseTemplateButton.setText(MDEUIMessages.ConfigurationTab_existingConfigIni);
		gd = new GridData();
		gd.horizontalSpan = 2;
		fUseTemplateButton.setLayoutData(gd);

		createText(group, MDEUIMessages.ConfigurationTab_templateLoc, 20);
		...
		createButtons(buttons, new String[] {MDEUIMessages.BaseBlock_workspaceS, MDEUIMessages.BaseBlock_filesystemS, MDEUIMessages.BaseBlock_variablesS});
	}
	...
	protected String getName() {
		return MDEUIMessages.ConfigurationTemplateBlock_name;
	}
	...
	protected void handleBrowseWorkspace() {
		...
		dialog.setTitle(MDEUIMessages.ConfigurationTab_fileSelection);
		dialog.setMessage(MDEUIMessages.ConfigurationTab_fileDialogMessage);
		dialog.setValidator(new ISelectionStatusValidator() {
			public IStatus validate(Object[] selection) {
				if (selection.length > 0 && selection[0] instanceof IFile)
					return new Status(IStatus.OK, MDEPlugin.getPluginId(), IStatus.OK, "", null); //$NON-NLS-1$

				return new Status(IStatus.ERROR, MDEPlugin.getPluginId(), IStatus.ERROR, "", null); //$NON-NLS-1$
			}
		});
	...
	protected void handleBrowseFileSystem() {
		...
		dialog.setText(MDEUIMessages.ConfigurationTab_configLocMessage);
