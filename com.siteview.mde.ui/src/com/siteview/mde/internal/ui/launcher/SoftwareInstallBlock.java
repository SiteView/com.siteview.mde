...
import com.siteview.mde.ui.launcher.ConfigurationTab;
...
public class SoftwareInstallBlock {
	...
	public void createControl(Composite parent) {
		Group group = SWTFactory.createGroup(parent, MDEUIMessages.ProfileBlock_0, 1, 1, GridData.FILL_HORIZONTAL);
		fGenerateProfileButton = SWTFactory.createCheckButton(group, MDEUIMessages.ProfileBlock_1, null, false, 1);
