...
import com.siteview.mde.internal.ui.preferences.MainPreferencePage;
...
public class WorkspaceDataBlock extends BaseBlock {
	...
	public void createControl(Composite parent) {
		...
		group.setText(MDEUIMessages.WorkspaceDataBlock_workspace);
		...
		fClearWorkspaceCheck.setText(MDEUIMessages.WorkspaceDataBlock_clear);
		...
		fClearWorkspaceRadio.setText(MDEUIMessages.WorkspaceDataBlock_clearWorkspace);
		...
		fClearWorkspaceLogRadio.setText(MDEUIMessages.WorkspaceDataBlock_clearLog);
		...
		fAskClearCheck.setText(MDEUIMessages.WorkspaceDataBlock_askClear);
		...
		configureDefaults.setText("<A>" + MDEUIMessages.WorkspaceDataBlock_configureDefaults + "</A>"); //$NON-NLS-1$//$NON-NLS-2$
