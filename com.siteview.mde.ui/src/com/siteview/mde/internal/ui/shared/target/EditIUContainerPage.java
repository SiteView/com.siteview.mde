...
public class EditIUContainerPage extends WizardPage implements IEditBundleContainerPage {
	...
	private static final IStatus BAD_IU_SELECTION = new Status(IStatus.ERROR, MDEPlugin.getPluginId(), Messages.EditIUContainerPage_0);
	...
	public IBundleContainer getBundleContainer() {
		...
		if (service == null) {
			MDEPlugin.log(new Status(IStatus.ERROR, MDEPlugin.getPluginId(), Messages.EditIUContainerPage_9));
		}
