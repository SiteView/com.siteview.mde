...
public class TargetPlatformPreferenceNode implements IPreferenceNode {
	 ...
	 */
	public String getId() {
		return "com.siteview.mde.ui.TargetPlatformPreferencePage"; //$NON-NLS-1$
	}
	...
	public String getLabelText() {
		return Platform.getResourceString(MDEPlugin.getDefault().getBundle(), "%preferences.target.name"); //$NON-NLS-1$
	}
