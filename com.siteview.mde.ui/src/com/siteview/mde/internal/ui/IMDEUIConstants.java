...
public interface IMDEUIConstants extends IPDEConstants {
	String PLUGIN_ID = "com.siteview.mde.ui"; //$NON-NLS-1$
	...
	String PLUGINS_VIEW_ID = "com.siteview.mde.ui.PluginsView"; //$NON-NLS-1$
	String DEPENDENCIES_VIEW_ID = "com.siteview.mde.ui.DependenciesView"; //$NON-NLS-1$
	String PERSPECTIVE_ID = "com.siteview.mde.ui.PDEPerspective"; //$NON-NLS-1$
