...
public class ModelChange {
	...
	private IMonitorModelBase fParent;
	...
	public ModelChange(IMonitorModelBase parent, boolean preSelected) {
		fParent = parent;
		fPreSelected = preSelected;
		fBundleLocalization = MDEManager.getBundleLocalization(fParent);
	...
	public IMonitorModelBase getParentModel() {
		return fParent;
	}
	...
	public boolean localizationSet() {
		String localization = MDEManager.getBundleLocalization(fParent);
