	...
	public void run(IAction action) {
		...
		try {
			...
			if (!pluginTable.isEmpty()) {
				...
				MessageDialog.openInformation(PlatformUI.getWorkbench().getActiveWorkbenchWindow().getShell(), MDEUIMessages.InternationalizeAction_internationalizeTitle, MDEUIMessages.InternationalizeAction_internationalizeMessage);
			}
		}
	}
