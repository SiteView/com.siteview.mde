...
public class MDEUIMessages extends NLS {
	private static final String BUNDLE_NAME = "com.siteview.mde.internal.ui.pderesources";//$NON-NLS-1$
	...
	static {
		...
		NLS.initializeMessages(BUNDLE_NAME, MDEUIMessages.class);
	}
