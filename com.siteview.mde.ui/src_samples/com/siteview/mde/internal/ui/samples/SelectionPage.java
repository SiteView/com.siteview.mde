...
public class SelectionPage extends WizardPage {
	...
	class SampleLabelProvider extends LabelProvider {
		...
		public SampleLabelProvider() {
			image = MDEPlugin.getDefault().getLabelProvider().get(MDEPluginImages.DESC_NEWEXP_TOOL);
		}
	...
	public SelectionPage(SampleWizard wizard) {
		...
		this.wizard = wizard;
		setTitle(MDEUIMessages.SelectionPage_title);
		setDescription(MDEUIMessages.SelectionPage_desc);
